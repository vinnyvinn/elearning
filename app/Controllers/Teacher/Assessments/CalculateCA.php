...
class CalculateCA extends TeacherController
{
    ...
    public function getCats()
    {
        ...
        if($existing) {
            ...
            return view('Teacher/Academic/Assessments/CalculateCA/existing', $data);
        }
        ...
        return view('Teacher/Academic/Assessments/CalculateCA/getCats', $data);
    }
