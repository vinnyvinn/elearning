...
class Ranking extends \App\Controllers\TeacherController
{
    ...
    {
        return $this->_renderPage('Teacher/Academic/Ranking/analysis/index_others', $this->data);
    }
    ...
    public function get()
    {
        ...
        $class = (new \App\Models\Sections())->find($section)->class->id;
        ...
        if ($semester =='yearly_average'){
            ...
            if ($class->type=='kg')
                return view('Teacher/Academic/Ranking/average_kg', $this->data);
                return view('Teacher/Academic/Ranking/average', $this->data);
        }
        return view('Teacher/Academic/Ranking/get', $this->data);
