...
$groups = (new \App\Models\ClassGroups())->where("section",$section->id)->orderBy('id', 'DESC')->findAll();
?>
<div class="card card-translucent">
    <div class="card-header">
        ...
        <a href="<?php echo site_url(route_to('admin.registration.groups.pdf',$section->id)); ?>" target="_blank" class="btn btn-sm btn-danger ml-1"><i
                    class="fa fa-cloud-download-alt"></i> PDF</a>
        <a href="<?php echo site_url(route_to("admin.registration.groups.print",$section->id));?>" target="_blank" class="btn btn-sm btn-danger ml-1"><i
