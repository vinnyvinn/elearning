        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Top Five Exam Results</h6><br/>
                </div>
...
<script>
   ...
   $('.print_result').on('click',function (){
    ...
    function getExamResults() {
        ...
        var e = {
            url: "<?php echo site_url(route_to('admin.academic.exam.get_results_top_five')); ?>",
            loader: true,
    ...
    function printResult(){
        var url = "/admin/academic/exams/print-results-top-five/"+exam+'/'+clss+'/'+section;
        window.location.href = url;
    }
    function downloadResult(){
        var url = "/admin/academic/exams/download-results-top-five/"+exam+'/'+clss+'/'+section;
        window.location.href = url;
    }
</script>