    ...
    <div class="card">
        <div class="card-header">
            <div class="row mt-3 justify-content-center" style="padding-left:1em;padding-right:1em">
                ...
                <div class="col-md-3">
                    <button class="btn btn-block btn-sm btn-primary" onclick="getRegularSchedule()"><i
...
<script>
    ...
    function getRegularSchedule() {
        ...
        if(section == '') {
            toast('Error', 'Please select class and section', 'error');
        } else {
            var d = {
                url: "<?php echo site_url(route_to('admin.academic.get_regular_schedule')); ?>",
                loader: true,
