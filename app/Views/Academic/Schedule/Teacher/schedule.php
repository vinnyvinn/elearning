<div class="card-body">
    ...
    if ($framework) {
        ...
        ?>
        <div>
            <a class="btn btn-sm btn-danger mb-2 pull-right" href="<?php echo site_url(route_to('admin.academic.get_teachers_schedule.pdf',$teacher->id,$class))?>" target="_blank"><i class="fa fa-download"></i>Pdf</a>
            <a class="btn btn-sm btn-danger mb-2 pull-right" href="<?php echo site_url(route_to('admin.academic.get_teachers_schedule.print',$teacher->id,$class))?>" target="_blank"><i class="fa fa-print"></i>Print</a>
        </div>
