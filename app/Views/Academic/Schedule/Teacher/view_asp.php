...
<div class="">
    ...
    if($framework) {
        ...
        ?>
        <div>
            <a class="btn btn-sm btn-danger mb-2 pull-right" href="<?php echo site_url(route_to('admin.academic.teachers_asp_schedule_pdf',$teacher->id))?>"><i class="fa fa-download"></i>Download</a>
        </div>
