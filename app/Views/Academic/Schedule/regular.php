...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Regular Timetable
            ...
            if(!isset($print) || $print !== true) {
                ?>
                <a class="pull-right float-right btn btn-sm btn-success m-1" href="<?php echo site_url(route_to('admin.class.sections.timetable_create', $section->id)); ?>"> <i class="fa fa-plus-square"></i> Create/Update Timetable</a>
                ...
                <a class="pull-right float-right btn btn-sm btn-danger m-1" target="_blank" href="<?php echo site_url(route_to('admin.academic.download_regular_schedule', $section->id)); ?>"> <i class="fa fa-download"></i> Download</a>
                <?php
            }
            ?>
        </h3>
