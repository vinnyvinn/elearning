                 ...
                 <div style="border: 5px solid #0680d1;margin-right: 0;max-width: 50%;height: 720px;" class="col-md-6">
                        ...
                        <div style="margin-left: 4%">
                            <table>
                                ...
                                <tr>
                                    <td  style="padding-left: 15%;margin-top: 0;padding-top: 0;padding-bottom: 0;font-size: 14px"><?php if (is_homeroom_sign_sem1($std_id) && !empty($teacher->signature)):?>
                                            Sign: <img src="<?php echo base_url('/uploads/'.$teacher->signature)?>" alt="" width="10%" style="margin-top: -2%">
                                        <?php else:?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td class="text-center" style="font-family: 'LLucida Calligraphy';font-size: 26px;padding-top: 0;padding-bottom: 0;border: none"><?php echo get_option('id_school_name_amharic','አስፓየር ዩዝ አካዳሚ')?></t</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="text-center" style="font-family: 'LLucida Calligraphy';font-size: 26px;padding-top: 0;padding-bottom: 0;border: none"><?php echo get_option('id_grade_range');?></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                          ...
                          <table class="table" style="border: 3px solid; font-family: Nyala">
                              <tr>
                                 <td style="padding-top: 0;padding-bottom: 0;font-size: 22px;border: none;padding-right: 0;"><b style="margin-left: 2%;">Address:<?php echo get_option("website_location")?></td>
                              </tr>
                              <tr>
                                  <?php
                            ...
                            <table class="table">
                                ...
                                <tr class="content">
                                    <td style="padding-top: 1%;padding-bottom: 1%;font-size: 18px;border: none">
                                        ...
                                        if (isset($total_marks[$semesters[0]->id]) && isset($total_marks[$semesters[1]->id])):
                                        ...
                                        <?php else:?>
                                            <span style="font-family: Cambria">Promoted to:  <b style="font-family: Bookman"><?php echo ($counter_fail < get_option('no_subject_failed') && $av_score >= get_option('promotion_pass_mark')) ? getNextClass($student->class->id) : '_________';?></b></span>
                                            &nbsp;&nbsp;<span style="font-family: Cambria">Detained at: <b style="font-family: Bookman"><?php echo ($counter_fail >= get_option('no_subject_failed') || $av_score < get_option('promotion_pass_mark')) ? $student->class->name :'_________';?></b></span>
                                        <?php endif;?>
                                    </td>
                                </tr>
                                </tbody>
                                ...
                                <tr class="content">
                                    <td style="padding-top: 1%;padding-bottom: 1%;border: none">
                                        ...
                                        <?php if (!empty($teacher->signature)):?>
                                            <div style="padding-top: 1%;padding-bottom:1%;font-size: 16px !important;margin-top: 0">Sign: <img src="<?php echo base_url('/uploads/'.$teacher->signature)?>" alt="" width="20%"></div>
                                        <?php endif;?>
                                    </td>
                                    <td style="padding-top: 1%;padding-bottom: 1%;border: none;">
                                        <?php if (is_director_sign($std_id) && !empty($dir)):?>
                                            <div style="padding-top: 1%;padding-bottom:1%;font-size: 16px !important;margin-top: 0"><img src="<?php echo base_url('/uploads/'.$dir->signature)?>" alt="" width="50%"></div>
                                        <?php endif;?>
                                    </td>
                                </tr>
                                </tbody>
                        ...
                        if($session && $student) {
                            ...
                            if(isset($semesters) && is_array($semesters) && count($semesters) > 0) {
                                ...
                                <div class="table-responsive" style="margin-top: 2%;margin-bottom: 2%;overflow-x: hidden;margin-left: -3.5%">
                                    ...
                                    <table class="table" width="100%" style="margin-top: 1%;margin-bottom: 2%">
                                        <tr>
                                            <th colspan="2" style="border: 1px solid;font-size: 14px;padding-top: 0;padding-bottom: 0;text-align: center">Conduct</th>
                                        </tr>
                                        <tr>
                                            <th style="border: 1px solid;font-size: 12px;padding-top: 0.5%;padding-bottom: 0.5%">First Semester</th>
                                            <th style="border: 1px solid;font-size: 12px;padding-top: 0.5%;padding-bottom: 0.5%">Second Semester</th>
                                        </tr>
                                        <tr>
                                            <td style="border: 1px solid;font-size: 14px;padding-top: 0;padding-bottom: 0;"><?php echo isset($conduct->first_sem_evaluation) ? $conduct->first_sem_evaluation : 'A';?></td>
                                            <td style="border: 1px solid;font-size: 14px;padding-top: 0;padding-bottom: 0"><?php echo isset($conduct->second_sem_evaluation) ? $conduct->second_sem_evaluation : 'A';?></td>
                                        </tr>
                                    </table>
                    ...
                    <div class="col-md-6" style="border: 5px solid #0680d1;padding-left: 0;padding-right: 0;max-width: 49%!important;margin-left: 1%;height: 720px !important;">
                        <?php if (!empty($saved_evaluations)):?>
                            <div>
                                ...
                                <table class="table" style="width: 100%">
                                    <tr>
                                        <th colspan="4" style="text-align: center;border: 1px solid;padding-top: 0.5%;padding-bottom: 0.5%"><span style="font-size: 18px">Tardy and Absent</span></th>
                                    </tr>
                                    <tr>
                                        <td style="border: 1px solid;font-size: 18px;padding-left: 0;padding-right: 0;word-spacing: -2px;padding-top:0;padding-bottom: 0">Number of tardy days</td>
                                        <td style="border: 1px solid;font-size: 18px;padding-top:0;padding-bottom: 0"><?php echo $student_evaluation->first_sem_tardy;?></td>
                                        <td style="border: 1px solid;font-size: 18px;padding-top:0;padding-bottom: 0"><?php echo $student_evaluation->second_sem_tardy;?></td>
                                    </tr>
                                    <tr>
                                        <td style="border: 1px solid;font-size: 18px;padding-top:0;padding-bottom: 0;padding-left: 0;padding-right: 0;word-spacing: -2px">Number of absent days</td>
                                        <td style="border: 1px solid;font-size: 18px;padding-top:0;padding-bottom: 0"><?php echo $student_evaluation->first_sem_absent;?></td>
                                        <td style="border: 1px solid;font-size: 18px;padding-top:0;padding-bottom: 0"><?php echo $student_evaluation->second_sem_absent;?></td>
                                    </tr>
                                </table>
                            </div>
                        <?php endif;?>
