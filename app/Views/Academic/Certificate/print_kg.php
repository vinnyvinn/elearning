                                ...
                                <div class="table-responsive" style="margin-top: 2%;margin-bottom: 2%;overflow-x: hidden">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid;font-size: 24px;padding-top: 0;padding-bottom: 0"><?php echo isset($conduct->second_sem_evaluation) ? $conduct->second_sem_evaluation : 'A';?></td>
                                        </tr>
                                    </table>
                                    <br>
