                                ...
                                <div class="table-responsive" style="margin-top: 2%;margin-bottom: 2%;overflow-x: hidden;margin-left: -3.5%">
                                                ...
                                                foreach ($semesters as $k => $item) {
                                                    ...
                                                    <td style="border: 1px solid;font-size: 10px;padding-top: 1%;padding-bottom: 1%"><?php
                                                       if ($k ==0) {
                                                           ...
                                                           echo '-';
                                                        ?></td>
                                                    <td style="border: 1px solid;font-size: 10px;padding-top: 1%;padding-bottom: 1%"><?php echo $k==0 ? getScore2($grading,$result) :'-';?></td>
                                                    <?php
                                                }
                                                ?>
                                    ...
                                    <table class="table" width="100%" style="margin-top: 1%;margin-bottom: 2%">
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid;font-size: 14px;padding-top: 0;padding-bottom: 0"><?php echo '-';?></td>
                                        </tr>
                                    </table>
                            ...
                            <div>
                                ...
                                <table class="table" style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 1px solid;font-size: 18px;padding-top:0;padding-bottom: 0"><?php echo '-';?></td>
                                    </tr>
                                    <tr>
