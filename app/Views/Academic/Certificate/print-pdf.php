                                    ...
                                    <table class="table" style="overflow-x: hidden">
                                       ...
                                       <th colspan="4" style="background: lightgrey;border: 1px solid;"><span style="font-size: 16px;font-weight: 900">Academic Result Record</span></th>
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid;font-size: 16px;padding-top: 1%;padding-bottom: 1%"><?php echo isset($conduct->first_sem_evaluation) ? $conduct->first_sem_evaluation : 'A';?></td>
                                            <td style="border: 1px solid;font-size: 16px;padding-top: 1%;padding-bottom: 1%"><?php echo isset($conduct->second_sem_evaluation) ? $conduct->second_sem_evaluation : 'A';?></td>
