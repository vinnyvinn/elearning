                    ...
                    <div style="border: 10px solid #0680d1;max-width: 750px!important;margin-left: 2%;height: 1130px !important;margin-right: -10%" class="col-md-6">
                        ...
                        <div class="products p-2">
                            <table class="table">
                                ...
                                <tr class="content">
                                    <td style="font-size: 28px;padding-top: 1%;padding-bottom: 1%;border: none;padding-right: 1%;">
                                        <?php
                                        $total_marks = [];
                                        $subs_arr = [];
                                        $counter = 0;
                                        ...
                                        ?>
                                            ...
                                            &nbsp;&nbsp;<span style="font-family: Cambria;margin-left: -2%">Detained At: <b style="font-family: Bookman"><?php echo ($counter_fail >= get_option('no_subject_failed') || $av_score < get_option('promotion_pass_mark')) ? $student->class->name :'_________';?></b></span>
                                        <?php else:?>
                                            <span style="font-family: Cambria">Promoted to: <b style="font-family: Bookman"><?php echo '_________';?></b></span>

                                            &nbsp;&nbsp;<span style="font-family: Cambria;margin-left: -2%">Detained at: <b style="font-family: Bookman"><?php echo '_________';?></b></span>
                                        <?php endif;?>
                                    </td>
                                </tr>
                                </tbody>
                                ...
                                <div class="table-responsive" style="margin-top: 2%;margin-bottom: 2%">
                                    <table class="table academic" style="overflow-x: hidden">
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid;font-size: 28px;padding-top: 0;padding-bottom: 0"><?php echo isset($conduct->second_sem_evaluation) ? $conduct->second_sem_evaluation : 'A';?></td>
