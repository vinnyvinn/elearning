    ...
    <div class="card">
        <div class="card-body">
            <div>
                ...
                action="<?php echo site_url(route_to('admin.academic.assessments.class_work.new_classwork_save')); ?>"  enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-4">
                                                ...
                                                <div>
                                                    ...
                                                    <table class="table table-sm table-borderless">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <label><input
                                                                            type="checkbox" <?php echo isset($item->corrects->$option['name']) ? 'checked' : ''; ?>
                                                            ...
                                                            <td>
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control form-control-sm" name="answers[][][<?php echo $option['name']?>]"
                                                                           value="<?php echo isset($item->answers->$option['name']) ? $item->answers->$option['name'] : '' ; ?>" rows="2"/>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                   <?php endforeach;?>
...
<script>
    ...
    $('.customSubmit').submit(function (e) {
        ...
        var e = {
            ...
            loader: true,
            url: "<?php echo site_url(route_to('admin.academic.assessments.class_work.new_classwork_save')); ?>"
        }
