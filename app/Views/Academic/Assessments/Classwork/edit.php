        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Edit Class Work</h6>
                </div>
...
<div class="container-fluid mt--6">
    <div class="card">
        <div class="card-body">
            <div>
                <form class="customSubmitii" loader="true" method="post" data-parsley-validate=""
                action="<?php echo site_url(route_to('admin.academic.assessments.class_work.save_edit', $classwork->id)); ?>">
                    <div class="row">
                        <div class="col-md-4">
                                ...
                                <select class="form-control form-control-sm" name="semester" required>
                                    ...
                                    if($semesters && count($semesters) > 0) {
                                        foreach ($semesters as $semester) {
                                            ?>
                                            <option <?php echo $classwork->semester->id == $semester->id ? 'selected' : ''; ?> value="<?php echo $semester->id; ?>"><?php echo $semester->name; ?></option>
                                            <?php
                                        }
                                    }
                                    ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="class" id="cls_class_id" class="form-control form-control-sm"
                                    ...
                                    foreach ($classes as $class) {
                                        ?>
                                        <option <?php echo $classwork->class->id == $class->id ? 'selected' : ''; ?> value="<?php echo $class->id; ?>"><?php echo $class->name; ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select id="subject_id" name="subject" class="form-control form-control-sm" required>
                                    <?php
                                    $subjects = $classwork->class->subjects;
                                    foreach ($subjects as $subject) {
                                        ?>
                                        <option <?php echo $classwork->subject->id == $subject->id ? 'selected' : ''; ?> value="<?php echo $subject->id; ?>"><?php echo $subject->name; ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm datepicker" name="given"
                                       value="<?php echo old('given', $classwork->given->format('m/d/Y')) ?>" required/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm datepicker" name="deadline"
                                       value="<?php echo old('deadline', $classwork->deadline->format('m/d/Y')) ?>" required/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" name="name"
                               value="<?php echo old('name', $classwork->name) ?>" required/>
                    </div>
                    <div>
                        <div>
                            <?php
                                        ...
                                        foreach ($existing->items as $key => $item) {
                                            ...
                                            <div class="item" style="background-color: #edeef2; padding:5px">
                                                ...
                                                <div class="form-group question_temp">
                                                    <label>Question</label>
                                                    <textarea name="question[<?php echo $key;?>]" class="form-control" rows="2"
                            ...
                            <div class="item" style="background-color: #edeef2; padding:5px">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Question #</label>
                                            <input type="number" name="question_number[]" min="1" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
...
<script>
    ...
    $('.customSubmit').submit(function (e) {
        ...
        var e = {
            ...
            loader: true,
            url: "<?php echo site_url(route_to('admin.academic.assessments.class_work.save_edit', $classwork->id)); ?>"
        }
