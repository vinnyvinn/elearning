...
<div class="container-fluid mt--6">
    <div class="card">
        <div class="card-header">
            <a href="<?php echo site_url(route_to('admin.academic.assessments.class_work.edit', $classwork->id)) ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Edit</a>
            <a target="_blank" href="<?php echo site_url(route_to('admin.academic.assessments.class_work.print_classwork', $classwork->id)) ?>" class="btn btn-info btn-sm"><i class="fa fa-print"></i> Print</a>
            <?php
            if  ($classwork->published == '0') {
                //publish
                ?>
                <a href="<?php echo site_url(route_to('admin.academic.assessments.class_work.publish', $classwork->id)) ?>" class="btn btn-sm btn-success">PUBLISH</a>
                <?php
            } else {
                //mark draft
                ?>
                <a href="<?php echo site_url(route_to('admin.academic.assessments.class_work.draft', $classwork->id)) ?>" class="btn btn-sm btn-dark">MARK DRAFT</a>
                <?php
            }
            ?>
        </div>
...
<script>
    ...
    function getCreateClassWork() {
        ...
        if (classid == '' || subject == '') {
            ...
            var e = {
                url: "<?php echo site_url(route_to('admin.academic.assessments.class_work.view_classwork', $classwork->id)); ?>",
                loader: true,
