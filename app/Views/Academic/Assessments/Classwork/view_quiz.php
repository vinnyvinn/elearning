...
?>
<div>
    <a target="_blank" href="<?php echo site_url(route_to('admin.academic.assessments.class_work.print_classwork', $classwork->id)) ?>" class="btn btn-info"><i class="fa fa-print"></i> Print</a>
</div>
<hr/>
<div class="row">
    <div class="col-md-6">
