        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-6 col-5 text-right">
                    <a class="btn btn-sm btn-success" href="<?php echo site_url(route_to('admin.academic.assessments.class_work.new_classwork')); ?>"><i class="fa fa-plus"></i> New Class Work</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function getClassWork() {
        ...
        if(section == '' || semester == '' || subject == '') {
            ...
            var e = {
                url: "<?php echo site_url(route_to('admin.academic.assessments.class_work.get')); ?>",
                loader: true,
