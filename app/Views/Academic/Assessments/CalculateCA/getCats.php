...
?>
<div>
    <form method="post" class="ajaxForm" loader="true" data-parsely-validate action="<?php echo site_url(route_to('admin.academic.assessments.calculate_cats')) ?>">
            ...
            <div class="col-md-4">
                ...
                if($assignments && count($assignments) > 0) {
                    ...
                    foreach ($assignments as $assignment) {
                        ?>
                        <div class="form-group">
                            <label><input type="checkbox" name="assignment[]" value="<?php echo $assignment->id; ?>" /> <?php echo $assignment->description.' ('.$assignment->out_of.')'; ?></label>
                        </div>
                        <?php
                    }
                }
