...
<div>
    ...
    <form class="customSubmit" method="post" data-parsley-validate
          action="<?php echo site_url(route_to('admin.academic.assessments.class_work.new_exam_save', $exam->id)); ?>">
        <div class="row">
            <div class="col-md-6">
...
<script>
    ...
    $('.customSubmit').submit(function (e) {
        ...
        var e = {
            ...
            loader: true,
            url: "<?php echo site_url(route_to('admin.academic.assessments.exams.new_exam_save', $exam->id)); ?>"
        }
