        ...
        <div class="card-body">
            <div>
                <div>
                    ...
                    $existing = false;
                    ?>
                    <form class="customSubmityy" method="post" data-parsley-validate
                          action="<?php echo site_url(route_to('admin.academic.assessments.quizes.new_quiz_save')); ?>">
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label for="sess">Quiz Name</label>
                                        ...
                                        <div>
                                            ...
                                            <table class="table table-sm table-borderless">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label><input type="checkbox" <?php echo @$item->corrects->$opt_name ? 'checked' : ''; ?> title="Check if this is the correct answer"
                                                                      name="correct[<?php echo $opt_name?>]"</label>
                                                    </td>
                                                    <td>
                                                        <div class="form-group">
                                                            <input type="text" class="form-control form-control-sm" name="answers[<?php echo $opt_name?>]" value="<?php echo $item->answers->$opt_name; ?>" rows="2"/>
                                                        </div>
                                                    </td>
                                                </tr>
                                       <?php endforeach;?>
...
<script>
    ...
    $('.customSubmit').submit(function (e) {
        ...
        var e = {
            ...
            loader: true,
            url: "<?php echo site_url(route_to('admin.academic.assessments.quizes.new_quiz_save')); ?>"
        }
