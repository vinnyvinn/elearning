            ...
            <div>
                <div>
                    ...
                    <form class="customSubmitii" method="post" data-parsley-validate
                          action="<?php echo site_url(route_to('admin.academic.assessments.quizes.save_edit_quiz', $quiz->id)); ?>">
                        <div class="row">
                            <div class="col-md-4">
...
<script>
    ...
    $('.customSubmit').submit(function (e) {
        ...
        var e = {
            ...
            loader: true,
            url: "<?php echo site_url(route_to('admin.academic.assessments.quizes.save_edit_quiz', $quiz->id)); ?>"
        }
