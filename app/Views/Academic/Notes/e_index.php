        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">E-Library</h6>
                </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <form class="ajaxForm" loader="true" method="post" data-parsley-validate
                                  action="<?php echo site_url(route_to('admin.academic.notes.elibrary')); ?>">
                                <div class="modal-header">
                                    <h6 class="modal-title" id="modal-title-default">Upload E-Library</h6>
                                ...
                                <div class="modal-body">
                                    <input type="hidden" name="is_elibrary" value="1">
                                    ...
                                    <div class="form-group">
                                        <label>Type</label>
                                        <select name="book_type" id="book_type" class="form-control form-control-sm select2"
                                                data-toggle="select2" required>
                                            <option value="1">Text Book</option>
                                            <option value="2">Supplementary Book</option>
    ...
    <div class="card">
        <div class="card-header">
            <div class="row mt-3 justify-content-center" style="padding-left:1em;padding-right:1em">
                ...
                <div class="col-md-3">
                    <select name="subject" id="subject_id" class="form-control select2">
                        <option value="all">view all</option>
                    </select>
                </div>
                <div class="col-md-3">
                    <select name="book_type" id="book_type_id" class="form-control select2">
                        <option value="all">view all</option>
                        <option value="1">Text Book</option>
                        <option value="2">Supplementary Book</option>
                    </select>
...
<script>
    ...
    function getNotes() {
        ...
        var type = $('#book_type_id').val();
        var subject = $("#subject_id").val();


        var e = {
            url: "<?php echo site_url(route_to('admin.academic.get_notes_e')); ?>",
            data: "class="+classId+"&book_type="+type+"&subject"+subject,
            loader: true
        };
