<div class="card">
  ...
  <a href="<?php echo site_url(route_to("admin.academic.semester_average_pdf",$section))?>" target="_blank" class="btn btn-danger btn-sm ml-1"><i class="fa fa-download">Pdf</i></a>
  <a href="<?php echo site_url(route_to("admin.academic.semester_average_print",$section))?>" target="_blank" class="btn btn-danger btn-sm ml-1"><i class="fa fa-print">Print</i></a>
    </div>
</div>
<?php
