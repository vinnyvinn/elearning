        ...
        <div class="card-header pb-0 mb--1">
            <div class="row">
                <div class="col-md-2 mb-1">
                    <select class="form-control form-control-sm select2" id="quarter_id" required>
...
<script>
    ...
    //    var section = $('#section_id').val();
        ...
        if(classes == '' || subject == '' || quarter == '') {
            toast("Error", "Please select all fields", 'error');
        } else {
            var e = {
                url: "<?php echo site_url(route_to('admin.academic.assessments.manual.get_the_assessments_q')); ?>",
                loader: true,
                data: "class=" + classes + "&quarter=" + quarter + "&subject="+subject
            };
