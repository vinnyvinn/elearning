...
$attendance = (new \App\Models\Attendance())->where('student',$student->id)->orderBy('date_created','DESC')->get()->getRow();
...
<script>
    ...
    function attendanceDetails(year,month,student){
        ...
        setTimeout(()=>{
            var d = {
                url: "<?php echo site_url(route_to('student.attendance.ajax')); ?>",
