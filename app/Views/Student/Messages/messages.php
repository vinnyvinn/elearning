                ...
                <div class="card-body">
                    <div class="mb-1">
                        <div style="max-height: 500px; overflow-y: scroll" id="messageArea" class="p-2 pb-3">
                            <?php
                            $messages = (new Messages())->where('session',active_session())->where(['student' => $student->id])->where('teacher',$teacher->id)->orderBy('id', 'ASC')->limit(100)->findAll();
                        ...
                        <div class="media align-items-center">
                            ...
                            if ($student->profile->avatar) {
                                ?>
                                <img alt="<?php echo $student->profile->name; ?>" class="avatar avatar-lg rounded-circle mr-4"
                                     src="<?php echo $student->profile->avatar; ?>">
                                <?php
                            }
                            ?>
                            <div class="media-body">
                                <form method="post" class="ajaxForm"
                                      action="<?php echo site_url(route_to('student.message.send', $teacher->id)); ?>" loader="true">
...
<script>
    ...
    function reloadMessages() {
        var d = {
            ...
            url: "<?php echo site_url(route_to('student.message.ajax_fetch')); ?>"
        }
