                    ...
                    <div class="col-md-6" style="border: 10px solid #0680d1;margin-right: 2%;max-width: 48%!important;height: 1098px !important;">
                        <div class="table-responsive" style="margin-top: 2%;margin-bottom: 2%">
                            <table class="table academic" style="overflow-x: hidden">
                                ...
                                <tr>
                                    <th colspan="7" class="text-center" style="border: 1px solid black">ACADEMIC RESULT RECORD</th>
                                </tr>
                                <tr>
                                    ...
                                    ?>
                                    <td style="border: 1px solid black;padding-right: 9px"><?php echo $quarter->name;?></td>
                                    <?php endforeach;?>
                                     <td style="border: 1px solid black;padding-right: 9px"><?php echo $semester->name;?></td>
                                    <?php endforeach;?>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                <tr>
                                 <td style="border: 1px solid black"><b>Average</b></td>
                                    <?php  foreach ($semesters as $semester):
                                        ...
                                        <?php endforeach;?>
                                        <td style="border: 1px solid black"><b><?php echo number_format($total_semesters[$semester->id]/count($subjects),2);?></b></td>
                                    <?php endforeach;?>
                                </tr>
                                <tr>
