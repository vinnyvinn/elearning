        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    Class Work: <b><?php echo $classwork->name; ?></b><br/>
                </div>
                <div class="col-md-6">
                    Academic Session: <b><?php echo getSession() ? getSession()->name : ''; ?></b><br/>
                    Date Given: <b><?php echo $classwork->given->format('d/m/Y'); ?></b><br/>
                    Deadline: <b><?php echo $classwork->deadline->format('d/m/Y'); ?></b><br/>
                </div>
            </div>
