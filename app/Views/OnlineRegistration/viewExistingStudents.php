                        ...
                        <div class="card-body pt-6">
                            <div class="text-center">
                                ...
                                <div>
                                    ...
                                    <h2><?php echo $student->info->admission_number; ?></h2>
                                </div>
                                <div>
                                    <h3>Enrolling for</h3>
                                    <h1><b><?php echo (new \App\Models\Classes())->find($student->info->class)->name; ?></b>,
                                        <?php if (isset($student->info->section) && $student->info->section):
                                            ?>
                                        <?php echo (new \App\Models\Sections())->find($student->info->section)->name; ?>
                                        <?php endif;?>
                                    </h1>
                                </div>
                                <div>
