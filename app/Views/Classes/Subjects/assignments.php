<div class="card">
    <?php
    $assignments = $subject->getAssignments($subject->subject);
            ...
            <table class="table">
                ...
                foreach ($assignments as $assignment) {
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-sm btn-primary" href="<?php echo site_url(route_to('admin.subjects.assignments.view', $subject->id, $assignment->id)); ?>">View</a></td>
                        <td>
                            <div class="dropdown">
