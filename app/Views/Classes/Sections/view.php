                ...
                <div class="table-responsive">
                    ...
                    <table class="table align-items-center table-flush table-sm mb-8">
                        ...
                        foreach ($subjects as $subject) {
                            ...
                            <tr>
                                <td><?php echo $n; ?></td>
                                <td><a href="<?php echo site_url(route_to('admin.subjects.view', $subject->id, $section->id)); ?>"><?php echo $subject->name; ?></a></td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            <a class="dropdown-item" href="<?php echo site_url(route_to('admin.subjects.view', $subject->id, $section->id)); ?>">View</a>
                                            <a class="dropdown-item" href="<?php echo site_url(route_to('admin.subjects.view', $subject->id, $section->id)); ?>">Lesson Plan</a>
                                            <a class="dropdown-item" href="<?php echo site_url(route_to('admin.subjects.assignments', $subject->id, $section->id)); ?>">Assignments</a>
                                            <a class="dropdown-item" href="<?php echo site_url(route_to('admin.subjects.notes', $subject->id, $section->id)); ?>">Notes</a>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <form class="ajaxForm" loader="true" method="post" data-parsley-validate
                                                      action="<?php echo site_url(route_to('admin.subjects.add_teacher', $subject->id, $section->id)); ?>">
                                                    <?php
                                                    if($tea) {
                                                        ?>
