...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">After School Program Timetable
            <a class="pull-right float-right btn btn-sm btn-success" href="<?php echo site_url(route_to('admin.class.sections.create_asp_schedule', $section->id)); ?>"> <i class="fa fa-plus-square"></i> Create/Update Timetable</a>
        </h3>
    </div>
    <?php
    if($framework) {
