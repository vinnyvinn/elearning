        ...
        <div class="table-responsive mt-2">
            <table class="table" id="datatable-basic">
                ...
                foreach ($notes as $note) {
                    ...
                    <tr>
                        <td><?php echo $n; ?></td>
                        <td><?php echo $note->section ? $note->section->name : ''; ?></td>
                        <td><?php echo $note->subject ? $note->subject->name : ''; ?></td>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <form class="ajaxForm" loader="true" method="post" data-parsley-validate
                                              action="<?php echo site_url(route_to('admin.subjects.notes', $note->subject->id, $note->section->id)); ?>">
                                            <input type="hidden" name="id" value="<?php echo $note->id; ?>" />
                                            <input type="hidden" name="class" value="<?php echo $note->section->class->id; ?>"/>
                                            <input type="hidden" name="section" value="<?php echo $note->section->id; ?>"/>
                                            <input type="hidden" name="subject" value="<?php echo $note->subject->id; ?>"/>
