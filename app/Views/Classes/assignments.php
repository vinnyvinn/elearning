                ...
                <div class="table-responsive mt-2">
                    <table class="table" id="datatable-basic">
                        ...
                        foreach ($assignments as $assignment) {
                            ...
                            <tr>
                                <td><?php echo $n; ?></td>
                                <td><?php echo $assignment->section->name; ?></td>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <form class="ajaxForm" loader="true" method="post" data-parsley-validate
                                                      action="<?php echo site_url(route_to('admin.subjects.assignments', $assignment->subject->id, $assignment->section->id)); ?>">
                                                    <input type="hidden" name="id" value="<?php echo $assignment->id; ?>"/>
                                                    <input type="hidden" name="class" value="<?php echo $assignment->section->class->id; ?>"/>
                                                    <input type="hidden" name="section" value="<?php echo $assignment->section->id; ?>"/>
