...
if($students && count($students) > 0) {
    ?>
    <form method="post" action="<?php echo site_url(route_to('admin.classes.move-student')); ?>" class="ajaxForm" loader="true">
        ...
        <div class="card-body">
            ...
            <div class="row justify-content-center">
                 <input type="hidden" name="newSession" id="newSession" value="<?php echo active_session();?>">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <button type="submit" id="filter" class="btn btn-primary btn-block"">
                        <i class="fa fa-chart-bar"></i> Move
                    </button>
                </div>
            </div>
        </div>
