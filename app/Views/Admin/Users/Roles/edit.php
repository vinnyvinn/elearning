        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Edit User Role: <?php echo $role->name; ?></h6>
                </div>
        ...
        <div class="card-body">
            <form method="post" action="<?php echo current_url(); ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="<?php echo old('name', $role->name); ?>" class="form-control" required/>
                </div>
                <div class="form-group">
                    <label for="desc">Description</label>
                    <textarea rows="5" class="form-control" name="description"
                              required><?php echo old('description', $role->description); ?></textarea>
                </div>
                <?php
