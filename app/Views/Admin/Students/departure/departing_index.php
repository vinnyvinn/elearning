        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Departing Students</h6>
                </div>
...
<div class="container-fluid mt--6">
    <div class="card">
        <div class="card-header pb-0 mb--1">
            <h4 class="h2">Departing Students</h4>
        </div>
        <div class="card-body">
            <div class="row justify-content-center">
                <div class="col-md-3">
                    <div class="form-group">
                        <select class="form-control select2" id="session" onchange="getClass()">
...
<script>
    ...
    var getStudents = function () {
        ...
        if (classId == '' || session == '' || sectionId == '') {
            ...
            var data = {
                url: "<?php echo site_url('ajax/students/') ?>" + session + "/class_depart/" + classId + "/section_depart/" + sectionId,
