        ...
        <td class="pr-20">
            ...
            <a href="<?php echo site_url(); ?>">
                <img class="logo logo-dark" alt="Aspire School Logo"
                     src="<?php echo get_logo(); ?>" style="width:20%;">
            </a>
        </td>
        <td>
            <h1><?php echo get_option('id_school_name', 'Aspire Youth Academy'); ?></h1>
            <?php
            ...
            ?>
            <h3 style="margin-left: 10%">Tel: <?php echo $phones?></h3>
            <h3><?php echo get_option('website_location');?></h3>
        </td>
    </tr>
    </tbody>
</table>
