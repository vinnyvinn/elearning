        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Accounting : Information</h6>
                </div>
...
<div class="container-fluid mt--6">
    <div class="card">
        <div class="card-header pb-0 mb--1">
            <h4 class="h2">Fee Payment Information</h4>
        </div>
        <div class="card-body">
...
<script>
    ...
    var getStudents = function () {
        ...
        if (classId == '' || session == '' || sectionId == '') {
            ...
            var data = {
                url: "<?php echo site_url('ajax/fee-information/') ?>" + session + "/class/" + classId + "/section/" + sectionId,
