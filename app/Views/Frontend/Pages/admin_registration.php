...
<div class="container">
    <?php
    $phones = get_option('admin_phone') ? json_decode(get_option('admin_phone')) : '';
    $phones = isset($phones) ? implode(" or ",$phones) : '';
    ?>
    <h1 class="title text-center mt-5">ADMINISTRATION REGISTRATION FORM</h1>
    <h5 class=" text-center">FOR ANY ASSISTANCE OR TO REGISTER
        BY PHONE; CALL: <?php echo $phones;?></h5>

    <div class="row">
        <div class="col-md-12">
            <?php if (get_option('admin_doc')):
                $docs = json_decode(get_option('admin_doc'));
                ?>
            <?php endif;?>
    ...
    <div class="container">
        <form method="post" class="ajaxForm" loader="true" action="<?php echo current_url(); ?>" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Position to be Employed</label>
                        <input type="text" name="position_employed" class="form-control" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="table-responsive">
                    <table class="table" id="filesTableTDoc">
                        ...
                        <tr>
                            <td>
                                <input type="text" name="admin_required_file_title[]" class="form-control"/>
                            </td>
                            <td>
                                <input type="file" name="admin_required_file[]" class="form-control" accept="application/pdf"/>
                            </td>
                            <td></td>
                        </tr>
                        </tbody>
