        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Final Results</h6>
                </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-4">
                    <select class="form-control select2" data-toggle="select2" id="student"
                        ...
                        foreach ($parent->students as $student) {
                            ?>
                            <option value="<?php echo $student->id; ?>" <?php if ($student->id==$parent->students[0]->id):?>selected<?php endif;?>><?php echo $student->profile->name; ?></option>
                            <script>
                ...
                <div class="col-md-4">
                    <button type="button" class="btn btn-sm btn-success btn-block" onclick="getFinalResult()"><i
...
<script>
    function getFinalResult() {
        ...
        if(student == '' || semester == '') {
            ...
            var e = {
                url: "<?php echo site_url(route_to('parent.continuous_assessments.view_final_result')); ?>",
                loader: true,
