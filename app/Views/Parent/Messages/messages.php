                ...
                <div class="card-body">
                    <div class="mb-1">
                                ...
                                foreach ($messages as $message) {
                                    if($message->direction == 's') {
                                        ...
                                        <div class="media media-comment">
                                            <?php
                                            if (isset($teacher->profile->avatar)) {
                                                ?>
                        ...
                        <div class="media align-items-center">
                            ...
                            if ($parent->avatar) {
                                ?>
                                <img alt="<?php echo $parent->name; ?>" class="avatar avatar-lg rounded-circle mr-4"
                                     src="<?php echo $parent->avatar; ?>">
                                <?php
                            }
                            ?>
                            <div class="media-body">
                                <form method="post" class="ajaxForm"
                                      action="<?php echo site_url(route_to('parent.message.send')); ?>" loader="true">
...
<script>
    ...
    function reloadMessages() {
        var d = {
            ...
            url: "<?php echo site_url(route_to('parent.message.ajax_fetch')); ?>"
        }
