                                ...
                                <tr>
                                    ...
                                    <td>
                                      <?php if (empty($req) || !isset($req->parent_check) || $req->parent_check==0):?>
                                        <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target=".mark_checked_<?php echo $payment->id; ?>">Mark Checked</button>
                                       <?php endif;?>
                                         <div class="modal fade mark_checked_<?php echo $payment->id; ?>" role="dialog" aria-labelledby="modal-default" style="display: none;" aria-hidden="true">
