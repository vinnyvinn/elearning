    ...
    <nav class="navbar navbar-top navbar-expand navbar-dark bg-primary border-bottom">
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <a class="navbar-bran" href="<?php echo site_url(route_to('parent.index')); ?>">
                ...
                <ul class="navbar-nav">
                    <?php if (isMobile()):?>
                        <li class="parent_mobile">
                            <a href="<?php echo site_url(route_to('parent.index')); ?>">
                    ...
                    <div class="p-3 parent_web">
                        ...
                        <div class="row">
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <a href="<?php echo site_url(route_to('parent.index')); ?>"><img title="dashboard" class="img" style="max-height: 100px" src="<?php echo base_url('assets/img/menu/home.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <a href="<?php echo site_url(route_to('parent.calendar')); ?>?navCalendar#navEventsCalendar"><img title="events calendar" class="img" style="max-height: 100px" src="<?php echo base_url('assets/img/menu/calender.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <a href="<?php echo site_url(route_to('parent.requirements')); ?>"><img title="requirements" class="img" style="max-height: 100px" src="<?php echo base_url('assets/img/menu/check list.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <a href="<?php echo site_url(route_to('parent.attendance')); ?>"><img title="attendance" class="img" style="max-height: 100px" src="<?php echo base_url('assets/img/menu/attendance.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                             <a href="<?php echo site_url(route_to('parent.payments')); ?>"><img title="payments" class="img" style="max-height: 100px" src="<?php echo base_url('assets/img/menu/payment.png') ?>" /> </a>
                            </div>
<!--                            <div class="col-md-2 col-sm-4 col-xs-6">-->
...
<!--                            </div>-->
                        ...
                        <div class="row">
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <a href="<?php echo site_url(route_to('parent.schedules.regular')); ?>"><img title="regular class-schedule" class="img" style="max-height: 100px" src="<?php echo base_url('assets/img/menu/class schedule.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <a href="<?php echo site_url(route_to('parent.exams.index')); ?>"><img title="exams" class="img" style="max-height: 100px" src="<?php echo base_url('assets/img/menu/exam schedule.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <a href="<?php echo site_url(route_to('parent.student-exam-results')); ?>"><img title="exam results" class="img" style="max-height: 100px" src="<?php echo base_url('assets/img/menu/exam result.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <a href="<?php echo site_url(route_to('parent.assessment.results')); ?>"><img title="assessment results" class="img" style="max-height: 100px" src="<?php echo base_url('assets/img/menu/continuous-improvement.png') ?>" /> </a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <a href="<?php echo site_url(route_to('parent.transport.route')); ?>"><img title="transport" class="img" style="max-height: 100px" src="<?php echo base_url('assets/img/menu/transport.png') ?>" /> </a>
                            </div>

                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <a href="<?php echo site_url(route_to('parent.student.certificate')); ?>"><img title="certificate" class="img" style="max-height: 100px" src="<?php echo base_url('assets/img/menu/certificate.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <a href="<?php echo site_url(route_to('parent.messages')); ?>"><img title="messages" class="img" style="max-height: 100px" src="<?php echo base_url('assets/img/menu/message.png') ?>" /></a>
                            </div>
                        </div>
                        <hr/>
                        ...
                        <div class="row">
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <a href="<?php echo site_url(route_to('parent.continuous_assessments.assignment')); ?>"><img title="assignments" class="img" style="max-height: 100px" src="<?php echo base_url('assets/img/menu/assignment.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <a href="<?php echo site_url(route_to('parent.continuous_assessments.classwork')); ?>"><img title="classwork" class="img" style="max-height: 100px" src="<?php echo base_url('assets/img/menu/class work.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <a href="<?php echo site_url(route_to('parent.continuous_assessments.quiz')); ?>"><img title="quiz" class="img" style="max-height: 100px" src="<?php echo base_url('assets/img/menu/quiz.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <a href="<?php echo site_url(route_to('parent.continuous_assessments.exam')); ?>"><img title="exams" class="img" style="max-height: 100px" src="<?php echo base_url('assets/img/menu/exam.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6">
                                <a href="<?php echo site_url(route_to('parent.continuous_assessments.final_result')); ?>"><img title="final grade" class="img" style="max-height: 100px" src="<?php echo base_url('assets/img/menu/result.png') ?>" /> </a>
                            </div>
                        </div>
                    </div>

                    <div class="p-3 parent_mobile">
                        <h3 class="title">Class</h3>
                        <div class="row mb10">
                            <div class="col-md-2 pb10 colmd2">
                                <a href="<?php echo site_url(route_to('parent.index')); ?>"><img title="dashboard" class="img" style="max-height: 50px" src="<?php echo base_url('assets/img/menu/home.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 pb10 colmd2">
                                <a href="<?php echo site_url(route_to('parent.calendar')); ?>"><img title="events calendar" class="img" style="max-height: 50px" src="<?php echo base_url('assets/img/menu/calender.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6 pb10 colmd2">
                                <a href="<?php echo site_url(route_to('parent.requirements')); ?>"><img title="requirements" class="img" style="max-height: 50px" src="<?php echo base_url('assets/img/menu/check list.png') ?>" /> </a>
                            </div>
                            <!--                            <div class="col-md-2 col-sm-4 col-xs-6">-->
                            <!--                                <a href="--><?php //echo site_url(route_to('parent.schedules.asp')); ?><!--"><img title="asp schedule" class="img" style="max-height: 100px" src="--><?php //echo base_url('assets/img/menu/class schedule.png') ?><!--" /> </a>-->
                            <!--                            </div>-->
                        ...
                        <div class="row mb10">
                            <div class="col-md-2 col-sm-4 col-xs-6 pb10 colmd2">
                                <a href="<?php echo site_url(route_to('parent.attendance')); ?>"><img title="attendance" class="img" style="max-height: 50px" src="<?php echo base_url('assets/img/menu/attendance.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6 pb10 colmd2">
                                <a href="<?php echo site_url(route_to('parent.payments')); ?>"><img title="payments" class="img" style="max-height: 50px" src="<?php echo base_url('assets/img/menu/payment.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6 pb10 colmd2">
                                <a href="<?php echo site_url(route_to('parent.schedules.regular')); ?>"><img title="regular class-schedule" class="img" style="max-height: 50px" src="<?php echo base_url('assets/img/menu/class schedule.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6 pb10 colmd2">
                                <a href="<?php echo site_url(route_to('parent.exams.index')); ?>"><img title="exams" class="img" style="max-height: 50px" src="<?php echo base_url('assets/img/menu/exam schedule.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6 pb10 colmd2">
                                <a href="<?php echo site_url(route_to('parent.student-exam-results')); ?>"><img title="exam results" class="img" style="max-height: 50px" src="<?php echo base_url('assets/img/menu/exam result.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6 pb10 colmd2">
                                <a href="<?php echo site_url(route_to('parent.assessment.results')); ?>"><img title="assessment results" class="img" style="max-height: 50px" src="<?php echo base_url('assets/img/menu/continuous-improvement.png') ?>" /> </a>
                            </div>
                        </div>
                        <div class="row mb10">
                            <div class="col-md-2 col-sm-4 col-xs-6 pb10 colmd2">
                                <a href="<?php echo site_url(route_to('parent.transport.route')); ?>"><img title="transport" class="img" style="max-height: 50px" src="<?php echo base_url('assets/img/menu/transport.png') ?>" /> </a>
                            </div>

                            <div class="col-md-2 col-sm-4 col-xs-6 pb10 colmd2">
                                <a href="<?php echo site_url(route_to('parent.student.certificate')); ?>"><img title="certificate" class="img" style="max-height: 50px" src="<?php echo base_url('assets/img/menu/certificate.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6 pb10 colmd2">
                                <a href="<?php echo site_url(route_to('parent.messages')); ?>"><img title="messages" class="img" style="max-height: 50px" src="<?php echo base_url('assets/img/menu/message.png') ?>" /></a>
                            </div>
                        </div>
                        <hr/>
                        <h3 class="title">Home School</h3>
                        <div class="row mb10">
                            <div class="col-md-2 col-sm-4 col-xs-6 pb10 colmd2">
                                <a href="<?php echo site_url(route_to('parent.continuous_assessments.assignment')); ?>"><img title="assignments" class="img" style="max-height: 50px" src="<?php echo base_url('assets/img/menu/assignment.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6 pb10 colmd2">
                                <a href="<?php echo site_url(route_to('parent.continuous_assessments.classwork')); ?>"><img title="classwork" class="img" style="max-height: 50px" src="<?php echo base_url('assets/img/menu/class work.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6 pb10 colmd2">
                                <a href="<?php echo site_url(route_to('parent.continuous_assessments.quiz')); ?>"><img title="quiz" class="img" style="max-height: 50px" src="<?php echo base_url('assets/img/menu/quiz.png') ?>" /> </a>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6 pb10 colmd2">
                                <a href="<?php echo site_url(route_to('parent.continuous_assessments.exam')); ?>"><img title="exams" class="img" style="max-height: 50px" src="<?php echo base_url('assets/img/menu/exam.png') ?>" /> </a>
                            </div>
                           <div class="col-md-2 col-sm-4 col-xs-6 pb10 colmd2">
                           <a href="<?php echo site_url(route_to('parent.continuous_assessments.final_result')); ?>"><img title="final grade" class="img" style="max-height: 50px" src="<?php echo base_url('assets/img/menu/result.png') ?>" /> </a>
                           </div>
                        </div>
                    </div>
                </div>
