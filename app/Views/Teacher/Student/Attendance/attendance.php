                ...
                <div class="card-body">
                    <div class="row">
                       ...
                       <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <h3 class="text-center text-white"><b>በዓላት / ዝግጅት - &nbsp;  </b><span class="text-yellow" style="border-left: 15px solid;border-right: 15px solid;"></span></h3>
                            <h3 class="text-center text-white"><b>ቅዳሜ / እሁድ - &nbsp;  </b><span class="text-blue" style="border-left: 15px solid;border-right: 15px solid;"></span></h3>
...
<script>
    $(function (){
        const att = document.getElementById('attend-table');
        att.scrollIntoView();
    })
</script>