                ...
                <div class="col-lg-8 col-9">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url(route_to('teacher.classes.view', $assignment->class->id)); ?>"><?php echo $assignment->class->name; ?></a></li>
                            <?php
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    if($assignment->file) {
                        ?>
                        <a class="btn btn-primary btn-sm" href="<?php echo $assignment->file; ?>"> <i class="fa fa-cloud-download-alt"></i> Download File</a>
                        <?php
                    } else {
                        echo "Not Found";
                    }
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    foreach ($submissions as $submission) {
                        ...
                        <?php if (isSuperAdmin()):?>
                                <a class="btn btn-sm btn-danger send-to-server-click" href="<?php echo site_url(route_to('teacher.subjects.assignments.delete_submission', $subject->id, $submission->id)); ?>" url="<?php echo site_url(route_to('teacher.subjects.assignments.delete_submission', $subject->id, $submission->id)); ?>" data="action:delete_submission|id:<?php echo $submission->id; ?>" warning-title="Confirm" warning-message="Are you sure you want to delete this student's assignment?" loader="true">Delete</a>
                               <?php endif;?>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <form class="ajaxForm" loader="true" method="post" data-parsley-validate
                                                  action="<?php echo site_url(route_to('teacher.subjects.assignments.award_marks', $subject->id, $assignment->id)); ?>">
