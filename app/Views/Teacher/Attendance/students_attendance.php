...
<div class="container-fluid mt--6">
    <div class="card">
        <form method="post" action="<?php echo site_url(route_to('teacher.attendance.saveStudent')); ?>" class="ajaxForm" loader="true">
            <div class="card-body">
...
<script>
    ...
    $('#date').on('change',function (){
        var data = {
            url: "<?php echo site_url(route_to('teacher.attendance.students.get_ajax_attendance')) ?>",
            data: "date=" + $(this).val(),
            loader: true
        };
    ...
    var getStudents = function () {
        ...
        if (classId == '' || sectionId == '' || date == '') {
            ...
            var data = {
                url: "<?php echo site_url(route_to('teacher.attendance.students.get_ajax')) ?>",
    ...
    $('.event').on('click',function (e){
        ...
        // if ($('#events').is(':checked') || $('#weekend').is(':checked') || $('#exams').is(':checked')){
        //   }else {
        //     return alert("You must check either Events/Holidays,Weekend or Exams.");
        // }
        ...
        var data = {
            url: "<?php echo site_url(route_to('teacher.attendance.students.post_ajax')) ?>",
