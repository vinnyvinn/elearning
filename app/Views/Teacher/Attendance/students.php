        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-6 col-5 text-right">
                    <a class="btn btn-sm btn-success" href="<?php echo site_url(route_to('teacher.attendance.record_students')); ?>"><i
    ...
    <div class="card">
        <div class="card-body">
            <div class="row justify-content-center">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <select class="form-control select2" data-toggle="select2" id="section" name="section">
...
<script>
    ...
    var getStudents = function () {
        var year = $('#year').val();
        var month = $('#month').val();
        var classId = 1; //not being used
        var sectionId = $('#section').val();
        if (classId == '' || sectionId == '') {
            toast('Error', 'Please make sure all filter fields are selected', 'error');
        } else {
            var data = {
                url: "<?php echo site_url('ajax/attendance/students/') ?>" + classId + "/section/" + sectionId + "/" + month + "/" + year,
