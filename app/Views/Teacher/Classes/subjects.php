            ...
            <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
                <div class="modal-content">
                    <form class="ajaxForm" loader="true" method="post"
                          action="<?php echo site_url(route_to('teacher.subjects.create')); ?>">
                ...
                foreach ($subjects as $subject) {
                    ...
                    <?php if (isSuperAdmin()):?>
                                    <a class="dropdown-item send-to-server-click text-danger" href="#!"
                                       url="<?php echo site_url(route_to('teacher.subjects.delete', $subject->id)); ?>"
                    ...
                    <?php endif;?>
                            ...
                            <div class="modal fade edit_subject<?php echo $subject->id; ?>" tabindex="-1"
                                ...
                                <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
                                    <div class="modal-content">
                                        <form class="ajaxForm" loader="true" method="post"
                                              action="<?php echo site_url(route_to('teacher.subjects.edit', $subject->id)); ?>">
