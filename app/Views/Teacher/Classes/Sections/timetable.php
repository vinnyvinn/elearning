...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Main Timetable
            <a class="pull-right float-right btn btn-sm btn-success" href="<?php echo site_url(route_to('teacher.class.sections.timetable_create', $section->id)); ?>"> <i class="fa fa-plus-square"></i> Create/Update Timetable</a>
        </h3>
    </div>
    <?php
    if($framework) {
