        ...
        <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
            <div class="modal-content">
                <form class="ajaxForm" loader="true" method="post"
                      action="<?php echo site_url(route_to('teacher.class.sections.groups.create', $section->id)); ?>">
                                ...
                                foreach ($groups as $group) {
                                    ...
                                    <?php if (isSuperAdmin()):?>
                                            <a class="btn btn-sm btn-danger send-to-server-click" href="#!"
                                               url="<?php echo site_url(route_to('teacher.class.sections.groups.delete', $group->id)); ?>"
...
<script>
    ...
    var fetchGroupMembers = function (id) {
        var e = {
            url: "<?php echo site_url(route_to('teacher.class.sections.groups.members')); ?>",
            data: "id=" + id,
            loader: true
        }
