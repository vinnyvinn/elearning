                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <form class="ajaxForm" loader="true" method="post" data-parsley-validate
                                  action="<?php echo site_url(route_to('teacher.subjects.notes', $subject->id, $section->id)); ?>">
                            ...
                            <form class="ajaxForm" loader="true" method="post" data-parsley-validate
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="deadline" class="form-control datepicker datetime" required value="<?php echo old('deadline'); ?>" />
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-success">Save</button>
    ...
    <div class="card bg-white text-white">
        <div class="ct-example card-header-pills" style="padding-bottom: 0; margin-bottom: 0">
            <ul class="nav nav-tabs-code nav-justified">
                <li class="nav-item">
                    <a class="nav-link <?php echo @$page == 'overview' ? 'active' : ''; ?>" href="<?php echo site_url(route_to('teacher.subjects.view', $subject->id, $section->id)); ?>" >Overview</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo @$page == 'notes' ? 'active' : ''; ?>" href="<?php echo site_url(route_to('teacher.subjects.notes', $subject->id, $section->id)); ?>" >Notes</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo @$page == 'assignments' ? 'active' : ''; ?>" href="<?php echo site_url(route_to('teacher.subjects.assignments', $subject->id, $section->id)); ?>" >Assignments</a>
                </li>
            </ul>
        </div>
    </div>
