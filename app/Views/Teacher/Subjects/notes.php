        ...
        <div class="table-responsive">
            <table class="table">
                ...
                foreach ($notes as $note) {
                    ...
                    <?php if (isSuperAdmin()):?>
                                    <a class="dropdown-item text-danger send-to-server-click" url="<?php echo site_url(route_to('teacher.subject.notes.delete', $note->id)); ?>" data="action:delete|id:<?php echo $note->id ?>" warning-title="Delete Note" warning-message="Do you really want to delete this entry?" loader="true" href="<?php echo site_url(route_to('admin.subject.notes.delete', $note->id)); ?>">Delete</a>
                               <?php endif;?>
                                </div>
                            </div>
