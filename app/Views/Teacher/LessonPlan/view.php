...
if(!$plan) {
    ...
    <div class="alert alert-warning">
        ...
        <a class="btn btn-primary text-white" href="<?php echo site_url(route_to('teacher.subjects.lesson_plan.create', $section->id, $subject->id)); ?>">Create Lesson Plan</a>
    </div>
    <?php
} else {
    ?>
    <div>
        <a class="btn btn-warning btn-sm pull-right float-right" href="<?php echo site_url(route_to('teacher.subjects.lesson_plan.update', $section->id, $subject->id, $plan->week, $plan->month)); ?>">Edit Lesson Plan</a>
        <a class="btn btn-primary btn-sm pull-right float-right" target="_blank" href="<?php echo site_url(route_to('teacher.subjects.lesson_plan.download', $section->id, $subject->id, $plan->week, $plan->month)); ?>">Download</a>
        <br/><br/>
        <div class="row">
            <div class="col-md-6">
                <div class="row">
