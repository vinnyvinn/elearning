            ...
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-6 col-5 text-right">
                    ...
                    if(current_user_can('create_exam_results')) {
                        ?>
                        <a class="btn btn-sm btn-success" href="<?php echo site_url(route_to('teacher.exam.record_results', $exam->id)); ?>"><i
    ...
    <div class="card bg-white text-white">
        <div class="ct-example card-header-pills" style="padding-bottom: 0; margin-bottom: 0">
            <ul class="nav nav-tabs-code nav-justified">
                <li class="nav-item">
                    <a class="nav-link <?php echo @$page == 'overview' ? 'active' : ''; ?>" href="<?php echo site_url(route_to('teacher.exams.view.index', $exam->id)); ?>" >Time Tables</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo @$page == 'results' ? 'active' : ''; ?>" href="<?php echo site_url(route_to('teacher.exams.view.results', $exam->id)); ?>" >Results</a>
                </li>
            </ul>
        </div>
    </div>
