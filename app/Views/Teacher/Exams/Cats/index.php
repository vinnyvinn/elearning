            ...
            <div class="table-responsive pt-2">
                <table class="table datatable" id="datatable-buttons">
                    ...
                    foreach ($cats as $current_exam) {
                        ...
                        <tr>
                            <td><?php echo $n; ?></td>
                            <td><a href="<?php echo site_url(route_to('teacher.exams.cats.view.index', $current_exam->id)); ?>"><?php echo $current_exam->name; ?></a></td>
                            ...
                            <td>
                                <a class="btn btn-sm btn-primary" href="<?php echo site_url(route_to('teacher.exams.cats.view.index', $current_exam->id)); ?>">View</a>
                                <?php
                                if(current_user_can('create_exam')){
                                    ?>
                                    <?php if (isSuperAdmin()):?>
                                    <a class="btn btn-sm btn-danger send-to-server-click" href="<?php echo site_url(route_to('teacher.exams.cats.delete', $current_exam->id)); ?>" url="<?php echo site_url(route_to('teacher.exams.cats.delete', $current_exam->id)); ?>" data="action:delete|id:<?php echo $current_exam->id; ?>" warning-title="Delete Test" warning-message="Do you really want to delete this continuous test and all of its data?" loader="true" ><i class="ni ni-fat-delete"></i> Delete</a>
                                    <?php endif;
                                }
                                ?>
                            </td>
