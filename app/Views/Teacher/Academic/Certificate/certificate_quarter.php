                        ...
                        <table class="table">
                            ...
                            foreach ($subjects as $subj) {
                                foreach ($semesters as $item) {
                                    ...
                                    $res = is_numeric($res) ? number_format(($res/count($item->quarters)),2) : '';
                                ...
                                <tr>
                                    ...
                                    foreach ($semesters as $item) {
                                        ...
                                        <td><?php
                                            ...
                                            $result = is_numeric($result) ? number_format(($result/count($item->quarters)),2) : '';
                                ...
                                foreach ($section->students as $student) {
                                    ...
                                    foreach ($subjects as $subj) {
                                        ...
                                        if(!isset($datasem1_arr_[$student->id])){
                                            ...
                                            $datasem1_arr_[$student->id] += (is_numeric($res) && $subj->optional == 0) ?  $res : 0;
                                        }
                                    }
                                        ...
                                        foreach ($subjects as $subj) {
                                            foreach ($semesters as $item) {
                                                ...
                                                if(!isset($data_arr_[$student->id])){
                                                    $data_arr_[$student->id] = (is_numeric($res) && $subj->optional == 0) ?  $res : 0;
                                                }else {
                                                    $data_arr_[$student->id] += (is_numeric($res) && $subj->optional == 0) ?  $res : 0;
                                                }
                                            }
