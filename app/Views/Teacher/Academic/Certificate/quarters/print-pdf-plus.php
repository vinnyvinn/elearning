                 ...
                 <div style="border: 10px solid #0680d1;margin-right: 1%;max-width: 49%;height: 720px;" class="col-md-6">
                        ...
                        <div style="margin-left: 4%">
                            <table>
                                ...
                                <tr>
                                    <td  style="padding-left: 15%;margin-top: 0;padding-top: 0;padding-bottom: 0;font-size: 20px"><?php if (is_homeroom_sign_sem1($std_id) && !empty($teacher->signature)):?>
                        ...
                        <div class="table-responsive" style="margin-top: 2%;margin-bottom: 2%;">
                            <table class="table academic" style="overflow-x: hidden;width: 80%">
                                ...
                                <tr><?php
                                    ...
                                    ?>
                                    <td colspan="<?php echo $cols?>" style="border: 1px solid black;font-size: 16px">ACADEMIC RESULT RECORD</td>
                                </tr>
                                <tr>
                                    <td class="text-center" style="border: 1px solid black;padding-right: 9px;padding-left: 4px;width: 1%;font-size: 10px">Subject</td>
                                    <?php
                                    $resultsModel = new \App\Libraries\YearlyResults($student->id, active_session());
                                    ...
                                    foreach ($semesters as $semester):?>
                                        ...
                                        <?php endforeach;?>
                                        <td style="border: 1px solid black;font-size: 11px;padding-left: 4px;padding-right: 5px"><?php echo $semester->name;?></td>
                                    <?php endforeach;?>
                                    <td style="border: 1px solid black;font-size: 11px;padding-left: 5px;padding-right: 5px;"><b>Yearly Average</b></td>
                                </tr>
                                </thead>
                                <tbody>
                                <?php
                                ...
                                foreach ($subjects as $subject):
                                    ?>
                                    <tr>
                                        <td style="border: 1px solid black;font-size: 10px;padding-left: 5px;padding-right: 5px;"><?php echo $subject->name;?></td>
                                        <?php
                                        $yearly_total =0;
                                        foreach ($semesters as $semester):
                                            $result_arr = array();
                                            ...
                                            foreach ($semester->quarters as $quarter):?>
                                                <td style="border: 1px solid black;font-size: 10px;padding-left: 5px;padding-right: 5px;">
                                                    <?php
                                                    $result = $resultsModel->getQuarterTotalResultsPerSubject($quarter->id, $subject->id);
                                ...
                                <?php endforeach;?>
                                <tr>
                                    <td style="border: 1px solid black;font-size: 10px;padding-left: 5px;padding-right: 5px;"><b>Total</b></td>
                                    <?php
                                    $total_sem = 0;
                                    foreach ($semesters as $semester):
                                ...
                                <tr>
                                    ...
                                    foreach ($semesters as $semester):
                                        ...
                                        <?php endforeach;?>
                                        <td style="border: 1px solid black;font-size: 14px;padding-left: 5px;padding-right: 5px;"><b><?php echo number_format($total_q/count($semester->quarters),2);?></b></td>
                                    <?php endforeach;?>
                                    <td style="border: 1px solid black;font-size: 14px;padding-left: 5px;padding-right: 5px;">
                                        <b>
                                            <?php
