    ...
    <div class="card">
        <div class="card-body">
            ...
            <div style="text-align: right">
                <a href="<?php echo site_url(route_to('teacher.academic.yearly_certificate.report-card', $std_id)); ?>" class="previous">&laquo; Previous </a>
                <a href="<?php echo site_url(route_to('teacher.academic.yearly_certificate.evaluation', $std_id)); ?>" class="next">Next &raquo;</a>
            </div>
        </div>
