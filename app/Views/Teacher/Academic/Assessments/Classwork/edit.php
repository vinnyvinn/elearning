    ...
    <div class="card">
        <div class="card-body">
            <div>
                ...
                action="<?php echo site_url(route_to('teacher.academic.assessments.class_work.save_edit', $classwork->id)); ?>">
                    <div class="row">
                        <div class="col-md-4">
...
<script>
    ...
    $('.customSubmit').submit(function (e) {
        ...
        var e = {
            ...
            loader: true,
            url: "<?php echo site_url(route_to('teacher.academic.assessments.class_work.save_edit', $classwork->id)); ?>"
        }
