        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Edit Quiz</h6>
                </div>
            ...
            <div>
                <div>
                    ...
                    <form class="customSubmit" method="post" data-parsley-validate
                          action="<?php echo site_url(route_to('teacher.academic.assessments.quizes.save_edit_quiz', $quiz->id)); ?>">
                        <div class="row">
                            <div class="col-md-4">
...
<script>
    ...
    $('.customSubmit').submit(function (e) {
        ...
        var e = {
            ...
            loader: true,
            url: "<?php echo site_url(route_to('teacher.academic.assessments.quizes.save_edit_quiz', $quiz->id)); ?>"
        }
