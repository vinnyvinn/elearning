        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Calculate Final Grade</h6>
                </div>
...
<script>
    ...
    function getCATS() {
        ...
        if (section == '' || subject == '' || sem == '') {
            toast("Error", "Please select all fields", 'error');
        } else {
            var e = {
                url: "<?php echo site_url(route_to('teacher.academic.assessments.calculate_fg.items')); ?>",
                loader: true,
                data: "class=" + section + "&subject=" + subject + "&semester=" + sem
            };
