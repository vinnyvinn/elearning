...
<div>
    <div class="alert alert-default">
        Continuous assessment for this class in this semester has already been calculated<br/>
        <?php if (isSuperAdmin()):?>
        <button class="btn btn-danger btn-sm text-white" id="delete" onclick="getDeleteCATS()">Delete</button>
        <?php endif;?>
    </div>
    <div>
...
<script>
    function getDeleteCATS() {
        ...
        if(classes == '' || subject == '' || semester == '') {
            ...
            var e = {
                url: "<?php echo site_url(route_to('teacher.academic.assessments.get_cats')); ?>",
                loader: true,
