...
<div class="container-fluid mt--6">
    <div class="card">
        <div class="card-header">
            <a  href="<?php echo site_url(route_to('teacher.academic.assessments.exams.edit', $exam->id)) ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Edit</a>
            <a target="_blank" href="<?php echo site_url(route_to('teacher.academic.assessments.exams.print_exam', $exam->id)) ?>" class="btn btn-info btn-sm"><i class="fa fa-print"></i> Print</a>
        </div>
        <div class="card-body">
            <div >
                <div class="row">
...
<script>
    ...
    function getCreateClassWork() {
        ...
        if (classid == '' || subject == '') {
            ...
            var e = {
                url: "<?php echo site_url(route_to('teacher.academic.assessments.exams.view_exam', $exam->id)); ?>",
                loader: true,
