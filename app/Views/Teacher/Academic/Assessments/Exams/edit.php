            ...
            <div>
                <div>
                    ...
                    <form class="customSubmit" method="post" data-parsley-validate
                          action="<?php echo site_url(route_to('teacher.academic.assessments.exams.save_edit', $exam->id)); ?>">
                        <div class="row">
                            <div class="col-md-4">
...
<script>
    ...
    $('.customSubmit').submit(function (e) {
        ...
        var e = {
            ...
            loader: true,
            url: "<?php echo site_url(route_to('teacher.academic.assessments.exams.save_edit', $exam->id)); ?>"
        }
