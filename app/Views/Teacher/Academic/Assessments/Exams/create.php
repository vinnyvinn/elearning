            ...
            <div>
                <div>
                    ...
                    <form class="customSubmit" method="post" data-parsley-validate
                          action="<?php echo site_url(route_to('teacher.academic.assessments.class_work.new_exam_save')); ?>">
                        <div class="row">
                            <div class="col-md-4">
...
<script>
    ...
    $('.customSubmit').submit(function (e) {
        ...
        var e = {
            ...
            loader: true,
            url: "<?php echo site_url(route_to('teacher.academic.assessments.exams.new_exam_save')); ?>"
        }
