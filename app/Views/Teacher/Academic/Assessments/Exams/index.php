        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-6 col-5 text-right">
                    <a class="btn btn-sm btn-success" href="<?php echo site_url(route_to('teacher.academic.assessments.exams.new_exam')); ?>"><i class="fa fa-plus"></i> New Exam</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <div class="row mt-3 justify-content-center" style="padding-left:1em;padding-right:1em">
                ...
                <div class="col-md-2">
                    <button class="btn btn-block btn-sm btn-primary" onclick="getCATExam()"><i
...
<script>
    ...
    function getCATExam() {
        ...
        if(section == '' || semester == '' || subject == '') {
            ...
            var e = {
                url: "<?php echo site_url(route_to('teacher.academic.assessments.exam.get')); ?>",
                loader: true,
