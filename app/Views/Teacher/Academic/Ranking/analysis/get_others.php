        ...
        if (isset($student->class->id)) {
          ...
          //$result = $resultModel->getSemesterTotalResultsPerSubjectClass($semester,$student->class->id);
           if (!isset($students_arr[$student->id])){
               $students_arr[$student->id] = (is_numeric($result) && $result > 0) ? number_format($result/count($subjects),2) : 0;
           }
    ...
    <table class="table">
       ...
       <tr>
        ...
        <tr>
            <th>ወ</th>
            <?php foreach ($classes as $class):?>
                <th><?php echo $class->departure_boys;?></th>
            <?php endforeach;?>
        </tr>
        <tr>
            <th>ሴ</th>
            <?php foreach ($classes as $class):?>
                <th><?php echo $class->departure_girls;?></th>
            <?php endforeach;?>
        </tr>
        <tr>
            <th>ድ</th>
            <?php foreach ($classes as $class):?>
                <th><?php echo $class->departure_girls+$class->departure_boys;?></th>
            <?php endforeach;?>
        </tr>
        <tr>
        ...
        <tr>
            <th>ድ</th>
            <?php foreach ($classes as $class):?>
                <th><?php echo (isset($boys_50_to_74[$class->id]) ? $boys_50_to_74[$class->id] : 0) + (isset($boys_50_to_74[$class->id]) ? $boys_50_to_74[$class->id] : 0);?></th>
            <?php endforeach;?>
        </tr>
        <tr>
        ...
        <tr>
            <th>ድ</th>
            <?php foreach ($classes as $class):?>
                <th><?php echo (isset($boys_75_to_100[$class->id]) ? $boys_75_to_100[$class->id] : 0) + (isset($boys_75_to_100[$class->id]) ? $boys_75_to_100[$class->id] : 0);?></th>
            <?php endforeach;?>
        </tr>
        <tr>
