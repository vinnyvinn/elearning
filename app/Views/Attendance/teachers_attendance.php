...
<script>
    ...
    $('#date').on('change',function (){
        var data = {
            url: "<?php echo site_url(route_to('admin.attendance.students.get_ajax_teacher_attendance')) ?>",
            data: "date=" + $(this).val(),
            loader: true
        };
    ...
    $('.event').on('click',function (e){
        ...
        var data = {
            url: "<?php echo site_url(route_to('admin.attendance.students.post_teacher_ajax')) ?>",
