        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Teachers Attendance</h6><br/>
                    <small class="text-white">Teachers Attendance</small>
                </div>
                <div class="col-lg-6 col-5 text-right">
                    <a class="btn btn-sm btn-success" href="<?php echo site_url(route_to('admin.attendance.record_teachers')); ?>"><i
    ...
    <div class="card">
        <div class="card-body">
            <div class="row justify-content-center">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <select class="form-control select2" data-toggle="select2" id="year">
                ...
                <div class="col-md-2">
                    <button type="button" id="filter" class="btn btn-sm btn-primary btn-block" onclick="getTeachers()">
...
<script>
    var getTeachers = function () {
        ...
        if (year == '' || month == '') {
            ...
            var data = {
                url: "<?php echo site_url(route_to('admin.attendance.get_teachers.ajax_monthly')); ?>",
