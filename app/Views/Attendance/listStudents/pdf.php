                ...
                <div class="row">
                    <div>
                        <table style="text-align: center">
                            ...
                            <tr>
                                <th><b style="font-size: 30px;font-weight: 900">Students Attendance </b> </th>
                            </tr>
                        </table>
                    </div>
                </div>
                        ...
                        <table class="table table-sm table-bordered" id="attend-table">
                            <thead class="thead-light">
                             <tr>
                                ...
                                <th style="font-size: 24px">Adm. No.</th>
                                <?php
                            ...
                            foreach ($students as $student) {
                                ...
                                <tr>
                                    ...
                                    <td style="font-size: 24px"><?php echo $student->profile->name?></td>
                                    <td style="font-size: 24px"><?php echo $student->admission_number; ?></td>
                                    <?php
                                    foreach ($dates as $date) {
                                    ...
                                    ?>
                                    <td style="font-size: 24px"><?php echo studentInfo($student->id,$month,$year)['present'];?></td>
                                    <td style="font-size: 24px"><?php echo studentInfo($student->id,$month,$year)['absent'];?></td>
                                    <td style="font-size: 24px"><?php echo studentInfo($student->id,$month,$year)['permission'];?></td>
                                    <td style="font-size: 24px"><?php echo studentInfo($student->id,$month,$year)['sick'];?></td>
                                    <td style="font-size: 24px"><?php echo studentInfo($student->id,$month,$year)['late'];?></td>
                                </tr>
                                <?php
                            }
                            ?>
