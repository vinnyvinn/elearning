...
<head>
    ...
    <title>Students Monthly Attendance Counter</title>
    <style>
        .red{
            background: red;
        }
                ...
                <div class="row">
                    <div>
                        <table style="text-align: center;margin-left: 30% !important;width: 100%">
                            ...
                            <tr>
                                <th><b style="font-size: 18px;font-weight: 900">Students Monthly Attendance Counter</b> </th>
                            </tr>
                            <tr>
                ...
                if ($attendance && count($attendance) > 0) {
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered" id="attend-table">
                            ...
                            <tr>
                                <th>Date </th>
                                <th style="font-size: 12px">No. of Present Students</th>
...
<script>
    var name = 'Students Monthly Attendance Counter';
