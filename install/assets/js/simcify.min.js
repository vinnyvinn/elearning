...
})(["jquery"], function (e)
{
    return function ()
    {
        function t(t, i)
        {
            return t || (t = r()), (a = e("#" + t.containerId)).length ? a : (i && (n = t, (a = e("<div/>").attr("id", n.containerId).addClass(n.positionClass)).appendTo(e(n.target)), a = a), a);
            var n
        }
        ...
        function s(i)
        {
            ...
            function l(t)
            {
                var i = t && !1 !== d.closeMethod ? d.closeMethod : d.hideMethod,
                    s = t && !1 !== d.closeDuration ? d.closeDuration : d.hideDuration,
                    r = t && !1 !== d.closeEasing ? d.closeEasing : d.hideEasing;
                if (!e(":focus", f).length || t) return clearTimeout(w.intervalId), f[i](
                    {
                        duration: s,
                        easing: r,
                        complete: function ()
                        {
                            o(f), clearTimeout(p), d.onHidden && "hidden" !== b.state && d.onHidden(), b.state = "hidden", b.endTime = new Date, n(b)
                        }
                    })
            }
            var d = r(),
                h = i.iconClass || d.iconClass;
            if (void 0 !== i.optionsOverride && (d = e.extend(d, i.optionsOverride), h = i.optionsOverride.iconClass || h), ! function (e, t)
            {
            ...
            }(0, i))
            {
                ...
                return i.iconClass && f.addClass(d.toastClass).addClass(h),
                    function ()
                    {
                        if (i.title)
                        {
                            var e = i.title;
                            d.escapeHtml && (e = s(i.title)), m.append(e).addClass(d.titleClass), f.append(m)
                        }
                    }(),
                    function ()
                    {
                        ...
                        {
                            var e = i.message;
                            d.escapeHtml && (e = s(i.message)), g.append(e).addClass(d.messageClass), f.append(g)
                        }
                    }(), d.closeButton && (y.addClass(d.closeClass).attr("role", "button"), f.prepend(y)), d.progressBar && (v.addClass(d.progressClass), f.prepend(v)), d.rtl && f.addClass("rtl"), d.newestOnTop ? a.prepend(f) : a.append(f),
                    function ()
                    {
                        var e = "";
                        switch (i.iconClass)
                        ...
                        f.attr("aria-live", e)
                    }(), f.hide(), f[d.showMethod](
                    {
                        duration: d.showDuration,
                        easing: d.showEasing,
                        complete: d.onShown
                    }), d.timeOut > 0 && (p = setTimeout(l, d.timeOut), w.maxHideTime = parseFloat(d.timeOut), w.hideEta = (new Date).getTime() + w.maxHideTime, d.progressBar && (w.intervalId = setInterval(function ()
                {
                    var e = (w.hideEta - (new Date).getTime()) / w.maxHideTime * 100;
                    v.width(e + "%")
                }, 10))), d.closeOnHover && f.hover(function ()
                {
                    clearTimeout(p), w.hideEta = 0, f.stop(!0, !0)[d.showMethod](
                        {
                            duration: d.showDuration,
                            easing: d.showEasing
                        })
                ...
                {
                    (d.timeOut > 0 || d.extendedTimeOut > 0) && (p = setTimeout(l, d.extendedTimeOut), w.maxHideTime = parseFloat(d.extendedTimeOut), w.hideEta = (new Date).getTime() + w.maxHideTime)
                }), !d.onclick && d.tapToDismiss && f.click(l), d.closeButton && y && y.click(function (e)
                {
                    e.stopPropagation ? e.stopPropagation() : void 0 !== e.cancelBubble && !0 !== e.cancelBubble && (e.cancelBubble = !0), d.onCloseClick && d.onCloseClick(e), l(!0)
                }), d.onclick && f.click(function (e)
                {
                    d.onclick(e), l()
                }), n(b), d.debug && console && console.log(b), f
            }
        }
        ...
        function o(e)
        {
            a || (a = t()), e.is(":visible") || (e.remove(), e = null, 0 === a.children().length && (a.remove(), c = void 0))
        }
        var a, l, c, u = 0,
            d = "error",
            h = "info",
            ...
            m = {
                ...
                {
                    var o = r();
                    a || t(o), i(n, o, s) || function (t)
                    {
                        for (var n = a.children(), s = n.length - 1; s >= 0; s--) i(e(n[s]), t)
                    }(o)
                },
                remove: function (i)
                {
                    var n = r();
                    return a || t(n), i && 0 === e(":focus", i).length ? void o(i) : void(a.children().length && a.remove())
                },
    ...
    function ()
    {
        ...
        {
            for (var i = e.version.split("."), n = t.version.split("."), s = 0; s < i.length; ++s)
            {
        ...
        }, e.latest = function (t, i)
        {
            ...
            var s = /(.*)~(.*)@v?(\d+\.\d+\.\d+[^\/]*)$/;
            /(.*)~(.*)/.test(t) || n(t);
            for (var r = Object.keys(e.modules), o = [], a = [], l = 0; l < r.length; l++)
            {
                var c = r[l];
                if (new RegExp(t + "@").test(c))
                {
                    var u = c.substr(t.length + 1);
                    null != s.exec(c) ? o.push(
                        {
                            version: u,
                            name: c
                        }) : a.push(
            ...
            {
                var d = o.sort(e.helper.semVerSort).pop().name;
                return !0 === i ? d : e(d)
            }
            return d = a.sort(function (e, t)
            {
        ...
        }, e.register("abpetkov~transitionize@0.0.3", function (e, t)
        {
            function i(e, t)
            {
                ...
                this.element = e, this.props = t ||
                    {}, this.init()
            }
            t.exports = i, i.prototype.isSafari = function ()
            {
        ...
        }), e.register("ftlabs~fastclick@v0.6.11", function (e, t)
        {
            ...
            {
                "use strict";
                var t, i, n, s, r, o = this.targetElement;
                ...
                return !(!this.deviceIsIOS || this.deviceIsIOS4 || !(s = o.fastClickScrollParent) || s.fastClickLastScrollTop === s.scrollTop) || (this.needsClick(o) || (e.preventDefault(), this.sendClick(o, e)), !1)
            ...
            }, "undefined" != typeof define && define.amd ? define(function ()
            {
                "use strict";
                return i
            }) : void 0 !== t && t.exports ? (t.exports = i.attach, t.exports.FastClick = i) : window.FastClick = i
        ...
        }), e.register("component~delegate@0.2.3", function (t, i)
        {
            ...
            {
                return s.bind(e, i, function (i)
                {
                    var s = i.target || i.srcElement;
                    i.delegateTarget = n(s, t, !0, e), i.delegateTarget && r.call(e, i)
                }, o)
        ...
        }), e.register("component~events@1.0.9", function (t, i)
        {
            ...
            i.exports = r, r.prototype.sub = function (e, t, i)
            {
            ...
            {
                var i, r = {
                        name: (i = e.split(/ +/)).shift(),
                        selector: i.join(" ")
                    },
                    o = this.el,
                    a = this.obj,
                    l = r.name,
                    c = (t = t || "on" + l, [].slice.call(arguments, 2));
                ...
                return r.selector ? u = s.bind(o, r.selector, l, u) : n.bind(o, l, u), this.sub(l, t, u), u
            ...
            }, r.prototype.unbindAllOf = function (e)
            {
                ...
                if (t)
                    for (var i in t) this.unbind(e, i)
            }
        }), e.register("switchery", function (t, i)
        {
            ...
            {
                return this.switcher = document.createElement("span"), this.jack = document.createElement("small"), this.switcher.appendChild(this.jack), this.switcher.className = this.options.className, this.events = o(this.switcher, this), this.switcher
            ...
            }, l.prototype.setSpeed = function ()
            {
                ...
                e = this.isChecked() ?
                    ...
                    } :
                    {
                        border: this.options.speed,
                        "box-shadow": this.options.speed
                    }, n(this.switcher, e), n(this.jack, t)
        ...
        ! function e(t, i, n)
        {
        ...
        }(
            {
                1: [function (n, s, r)
                {
                    ...
                    var a, l, c, u, d = n("./modules/handle-dom"),
                        h = n("./modules/utils"),
                    ...
                    r.default = c = u = function ()
                    {
                        ...
                        var s = arguments[0];
                        if ((0, d.addClass)(t.body, "stop-scrolling"), (0, p.resetInput)(), s === i) return (0, h.logStr)("SweetAlert expects at least 1 attribute!"), !1;
                        var r = (0, h.extend)(
                            {}, g.default);
                        switch (typeof s)
                        {
                            case "string":
                                r.title = s, r.text = arguments[1] || "", r.type = arguments[2] || "";
                                break;
                            case "object":
                                if (s.title === i) return (0, h.logStr)('Missing "title" argument!'), !1;
                                r.title = s.title;
                                for (var o in g.default) r[o] = n(o);
                                r.confirmButtonText = r.showCancelButton ? "Confirm" : g.default.confirmButtonText, r.confirmButtonText = n("confirmButtonText"), r.doneFunction = arguments[1] || null;
                                break;
                            default:
                                return (0, h.logStr)('Unexpected type of argument! Expected "string" or "object", got ' + typeof s), !1
                        }(0, v.default)(r), (0, p.fixVerticalPosition)(), (0, p.openModal)(arguments[1]);
                        for (var c = (0, p.getModal)(), y = c.querySelectorAll("button"), w = ["onclick", "onmouseover", "onmouseout", "onmousedown", "onmouseup", "onfocus"], b = function (e)
                        {
                            return (0, f.handleButton)(e, r, c)
                        }, C = 0; C < y.length; C++)
                            for (var _ = 0; _ < w.length; _++)
                            {
                                var x = w[_];
                                y[C][x] = b
                            }(0, p.getOverlay)().onclick = b, a = e.onkeydown, e.onkeydown = function (e)
                    {
                        return (0, m.default)(e, r, c)
                    }, e.onfocus = function ()
                    {
                        setTimeout(function ()
                        {
                    ...
                    }, c.setDefaults = u.setDefaults = function (e)
                    {
                        ...
                        (0, h.extend)(g.default, e)
                    }, c.close = u.close = function ()
                    {
                        var n = (0, p.getModal)();
                        (0, d.fadeOut)((0, p.getOverlay)(), 5), (0, d.fadeOut)(n, 5), (0, d.removeClass)(n, "showSweetAlert"), (0, d.addClass)(n, "hideSweetAlert"), (0, d.removeClass)(n, "visible");
                        var s = n.querySelector(".sa-icon.sa-success");
                        (0, d.removeClass)(s, "animate"), (0, d.removeClass)(s.querySelector(".sa-tip"), "animateSuccessTip"), (0, d.removeClass)(s.querySelector(".sa-long"), "animateSuccessLong");
                        ...
                        return (0, d.removeClass)(o, "pulseWarning"), (0, d.removeClass)(o.querySelector(".sa-body"), "pulseWarningIns"), (0, d.removeClass)(o.querySelector(".sa-dot"), "pulseWarningIns"), setTimeout(function ()
                        {
                            var e = n.getAttribute("data-custom-class");
                            (0, d.removeClass)(n, e)
                        }, 300), (0, d.removeClass)(t.body, "stop-scrolling"), e.onkeydown = a, e.previousActiveElement && e.previousActiveElement.focus(), l = i, clearTimeout(n.timeout), !0
                    }, c.showInputError = u.showInputError = function (e)
                    {
                        ...
                        (0, d.addClass)(n, "show"), n.querySelector("p").innerHTML = e, setTimeout(function ()
                        {
                            c.enableButtons()
                    ...
                    }, void 0 !== e ? e.sweetAlert = e.swal = c : (0, h.logStr)("SweetAlert is a frontend module!"), s.exports = r.default
                },
                    {
                ...
                3: [function (t, i, n)
                {
                    ...
                    var s = t("./utils"),
                        ...
                        {
                            var i = !0;
                            (0, r.hasClass)(e, "show-input") && ((i = e.querySelector("input").value) || (i = "")), t.doneFunction(i), t.closeOnConfirm && sweetAlert.close(), t.showLoaderOnConfirm && sweetAlert.disableButtons()
                        },
                        a = function (e, t)
                        {
                    ...
                    n.default = {
                        handleButton: function (t, i, n)
                        {
                            ...
                            switch (f && i.confirmButtonColor && (c = i.confirmButtonColor, u = (0, s.colorLuminance)(c, -.04), d = (0, s.colorLuminance)(c, -.14)), h.type)
                            {
                                case "mouseover":
                                    l(u);
                                    break;
                                ...
                                case "focus":
                                    ...
                                    f ? w.style.boxShadow = "none" : y.style.boxShadow = "none";
                                    break;
                                case "click":
                                    var b = n === p,
                                        C = (0, r.isDescendant)(n, p);
                                    if (!b && !C && g && !i.allowOutsideClick) break;
                                    f && v && g ? o(n, i) : v && g || m ? a(0, i) : (0, r.isDescendant)(n, p) && "BUTTON" === p.tagName && sweetAlert.close()
                            }
                        },
                        handleConfirm: o,
                        handleCancel: a
                ...
                4: [function (i, n, s)
                {
                    ...
                    s.hasClass = r, s.addClass = function (e, t)
                    {
                        r(e, t) || (e.className += " " + t)
                ...
                5: [function (t, n, s)
                {
                    ...
                    s.default = function (t, n, s)
                    {
                        ...
                        {
                            for (var h = a.target || a.srcElement, p = -1, f = 0; f < d.length; f++)
                                if (h === d[f])
                                {
                                    p = f;
                                    break
                                } 9 === l ? (h = -1 === p ? c : p === d.length - 1 ? d[0] : d[p + 1], (0, r.stopEventPropagation)(a), h.focus(), n.confirmButtonColor && (0, o.setFocusStyle)(h, n.confirmButtonColor)) : 13 === l ? ("INPUT" === h.tagName && (h = c, c.focus()), h = -1 === p ? c : i) : 27 === l && !0 === n.allowEscapeKey ? (h = u, (0, r.fireClick)(h, a)) : h = i
                        }
                    }, n.exports = s.default
                },
                    {
                ...
                6: [function (i, n, s)
                {
                    ...
                    s.sweetAlertInitialize = u, s.getModal = d, s.getOverlay = p, s.getInput = h, s.setFocusStyle = function (e, t)
                    {
                    ...
                    {
                        var n = d();
                        (0, a.fadeIn)(p(), 10), (0, a.show)(n), (0, a.addClass)(n, "showSweetAlert"), (0, a.removeClass)(n, "hideSweetAlert"), e.previousActiveElement = t.activeElement, n.querySelector("button.confirm").focus(), setTimeout(function ()
                        {
                    ...
                    }, s.resetInput = function ()
                    {
                        var e = d(),
                            t = h();
                        (0, a.removeClass)(e, "show-input"), t.value = l.default.inputValue, t.setAttribute("type", l.default.inputType), t.setAttribute("placeholder", l.default.inputPlaceholder), f()
                    }, s.resetInputError = f, s.fixVerticalPosition = function ()
                    {
                ...
                8: [function (e, t, n)
                {
                    ...
                    n.default = function (e)
                    {
                        ...
                        if (n.innerHTML = e.html ? e.title : (0, o.escapeHtml)(e.title).split("\n").join("<br>"), l.innerHTML = e.html ? e.text : (0, o.escapeHtml)(e.text || "").split("\n").join("<br>"), e.text && (0, o.show)(l), e.customClass)(0, o.addClass)(t, e.customClass), t.setAttribute("data-custom-class", e.customClass);
                        else
                        {
                            var d = t.getAttribute("data-custom-class");
                            (0, o.removeClass)(t, d), t.setAttribute("data-custom-class", "")
                        }
                        if ((0, o.hide)(t.querySelectorAll(".sa-icon")), e.type && !(0, s.isIE8)())
                        {
                            var h = function ()
                            {
                                ...
                                var l = i; - 1 !== ["success", "error", "warning", "info"].indexOf(e.type) && (l = t.querySelector(".sa-icon.sa-" + e.type), (0, o.show)(l));
                                var c = (0, r.getInput)();
                                switch (e.type)
                                {
                                    case "success":
                                        (0, o.addClass)(l, "animate"), (0, o.addClass)(l.querySelector(".sa-tip"), "animateSuccessTip"), (0, o.addClass)(l.querySelector(".sa-long"), "animateSuccessLong");
                                        break;
                                    case "error":
                                        (0, o.addClass)(l, "animateErrorIcon"), (0, o.addClass)(l.querySelector(".sa-x-mark"), "animateXMark");
                                        break;
                                    case "warning":
                                        (0, o.addClass)(l, "pulseWarning"), (0, o.addClass)(l.querySelector(".sa-body"), "pulseWarningIns"), (0, o.addClass)(l.querySelector(".sa-dot"), "pulseWarningIns");
                                        break;
                                    case "input":
                                    case "prompt":
                                        c.setAttribute("type", e.inputType), c.value = e.inputValue, c.setAttribute("placeholder", e.inputPlaceholder), (0, o.addClass)(t, "show-input"), setTimeout(function ()
                                        {
                        ...
                        if (e.imageUrl)
                        {
                            ...
                            p.style.backgroundImage = "url(" + e.imageUrl + ")", (0, o.show)(p);
                            var f = 80,
                                m = 80;
                            if (e.imageSize)
                            {
                                var g = e.imageSize.toString().split("x"),
                                    v = g[0],
                                    y = g[1];
                                v && y ? (f = v, m = y) : logStr("Parameter imageSize expects value with format WIDTHxHEIGHT, got " + e.imageSize)
                            }
                            p.setAttribute("style", p.getAttribute("style") + "width:" + f + "px; height:" + m + "px")
                        }
                        t.setAttribute("data-has-cancel-button", e.showCancelButton), e.showCancelButton ? c.style.display = "inline-block" : (0, o.hide)(c), t.setAttribute("data-has-confirm-button", e.showConfirmButton), e.showConfirmButton ? u.style.display = "inline-block" : (0, o.hide)(u), e.cancelButtonText && (c.innerHTML = (0, o.escapeHtml)(e.cancelButtonText)), e.confirmButtonText && (u.innerHTML = (0, o.escapeHtml)(e.confirmButtonText)), e.confirmButtonColor && (u.style.backgroundColor = e.confirmButtonColor, u.style.borderLeftColor = e.confirmLoadingButtonColor, u.style.borderRightColor = e.confirmLoadingButtonColor, (0, r.setFocusStyle)(u, e.confirmButtonColor)), t.setAttribute("data-allow-outside-click", e.allowOutsideClick);
    ...
    function (e, t)
    {
        "function" == typeof define && define.amd ? define(["jquery"], t) : "object" == typeof exports ? module.exports = t(require("jquery")) : e.Dropify = t(e.jQuery)
    }(this, function (e)
    {
        var t = "dropify";
        ...
        function i(t, i)
        {
            window.File && window.FileReader && window.FileList && window.Blob && (this.element = t, this.input = e(this.element), this.wrapper = null, this.preview = null, this.filenameWrapper = null, this.settings = e.extend(!0,
                {
                    defaultFile: "",
                    maxFileSize: 0,
                    minWidth: 0,
                ...
                }, i, this.input.data()), this.imgFileExtensions = ["png", "jpg", "jpeg", "gif", "bmp"], this.errorsEvent = e.Event("dropify.errors"), this.isDisabled = !1, this.isInit = !1, this.file = {
                object: null,
                name: null,
                size: null,
                width: null,
        ...
        }, i.prototype.readFile = function (t)
        {
            if (t.files && t.files[0])
            {
                ...
                this.clearErrors(), this.showLoader(), this.setFileInformations(s), i.readAsDataURL(s), this.errorsEvent.errors = [], this.checkFileSize(), i.onload = function (e)
                {
                    r = e.target.result, this.isImage() ? (n.src = e.target.result, n.onload = function ()
                    {
                        o.setFileDimensions(this.width, this.height), o.validateImage(), o.input.trigger(a, [r])
                    }) : this.input.trigger(a, [r])
                }.bind(this), this.input.on("dropify.fileReady", this.onFileReady)
            }
        }, i.prototype.onFileReady = function (e, t)
        {
            if (this.input.off("dropify.fileReady", this.onFileReady), 0 === this.errorsEvent.errors.length) this.setPreview(t, this.file.name);
            else
            {
        ...
        }, i.prototype.setPreview = function (t)
        {
            ...
            if (this.hideLoader(), !0 === this.isImage())
            {
                ...
                this.settings.height && n.css("max-height", this.settings.height), n.appendTo(i)
            }
            else e("<i />").attr("class", "dropify-font-file").appendTo(i), e('<span class="dropify-extension" />').html(this.getFileType()).appendTo(i);
            this.preview.fadeIn()
        ...
        }, i.prototype.clearElement = function ()
        {
            if (0 === this.errorsEvent.errors.length)
            {
                ...
                this.input.trigger(t, [this]), !1 !== t.result && (this.resetFile(), this.input.val(""), this.resetPreview(), this.input.trigger(e.Event("dropify.afterClear"), [this]))
            }
        ...
        }, i.prototype.translateMessages = function ()
        {
            for (var e in this.settings.tpl)
                for (var t in this.settings.messages) this.settings.tpl[e] = this.settings.tpl[e].replace("{{ " + t + " }}", this.settings.messages[t])
        ...
        }, i.prototype.maxFileSizeToByte = function ()
        {
            ...
            if (0 !== this.settings.maxFileSize)
            {
                ...
                "K" === t ? e = 1024 * parseFloat(this.settings.maxFileSize) : "M" === t ? e = 1048576 * parseFloat(this.settings.maxFileSize) : "G" === t && (e = 1073741824 * parseFloat(this.settings.maxFileSize))
            }
            return e
        ...
        {
            void 0 !== this.errorsContainer && this.errorsContainer.children("ul").html("")
        }, i.prototype.showError = function (e)
        {
            void 0 !== this.errorsContainer && this.errorsContainer.children("ul").append("<li>" + this.getError(e) + "</li>")
        }, i.prototype.getError = function (e)
        {
            var t = this.settings.error[e],
                i = "";
            return "fileSize" === e ? i = this.settings.maxFileSize : "minWidth" === e ? i = this.settings.minWidth : "maxWidth" === e ? i = this.settings.maxWidth : "minHeight" === e ? i = this.settings.minHeight : "maxHeight" === e ? i = this.settings.maxHeight : "imageFormat" === e && (i = this.settings.allowedFormats.join(" ")), "" !== i ? t.replace("{{ value }}", i) : t
    ...
    function (e, t)
    {
        "function" == typeof define && define.amd ? define(["exports"], t) : "object" == typeof exports && "string" != typeof exports.nodeName ? t(exports) : t(e.commonJsStrict = {})
    }(this, function (e)
    {
        "function" != typeof Promise && function (e)
        {
            ...
            function i(e)
            {
                ...
                this._state = null, this._value = null, this._deferreds = [], a(e, t(s, this), t(r, this))
            }
            ...
            function s(e)
            {
                try
                {
                    ...
                    {
                        var i = e.then;
                        if ("function" == typeof i) return void a(t(i, e), t(s, this), t(r, this))
                    }
        ...
        }(this), "function" != typeof window.CustomEvent && function ()
        {
        ...
        }(), HTMLCanvasElement.prototype.toBlob || Object.defineProperty(HTMLCanvasElement.prototype, "toBlob",
            {
                ...
                {
                    for (var n = atob(this.toDataURL(t, i).split(",")[1]), s = n.length, r = new Uint8Array(s), o = 0; o < s; o++) r[o] = n.charCodeAt(o);
                    e(new Blob([r],
                        {
                            type: t || "image/png"
                        }))
        ...
        function c(e, t)
        {
            e = e ||
                {};
            for (var i in t) t[i] && t[i].constructor && t[i].constructor === Object ? (e[i] = e[i] ||
                {}, c(e[i], t[i])) : e[i] = t[i];
            return e
        }
        ...
        y.parse = function (e)
        {
            return e.style ? y.parse(e.style[i]) : e.indexOf("matrix") > -1 || e.indexOf("none") > -1 ? y.fromMatrix(e) : y.fromString(e)
        }, y.fromMatrix = function (e)
        {
            var t = e.substring(7).split(",");
            return t.length && "none" !== e || (t = [1, 0, 0, 1, 0, 0]), new y(m(t[4]), m(t[5]), parseFloat(t[0]))
        ...
        {
            var e = v[R.globals.translate].suffix || "";
        ...
        function C(e, t, i)
        {
            ...
            switch (e.width = t.width, e.height = t.height, r.save(), i)
            {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    e.width = s, e.height = n, r.rotate(90 * Math.PI / 180), r.scale(1, -1);
                    break;
                case 6:
                    e.width = s, e.height = n, r.rotate(90 * Math.PI / 180), r.translate(0, -s);
                    break;
                case 7:
                    e.width = s, e.height = n, r.rotate(-90 * Math.PI / 180), r.translate(-n, s), r.scale(1, -1);
                    break;
                case 8:
                    e.width = s, e.height = n, r.translate(0, n), r.rotate(-90 * Math.PI / 180)
            }
        ...
        function D(e)
        {
            ...
            {
                var e = {};
                e[i] = s.toString(), e[t] = o.toString(), h(n.elements.preview, e)
            }
            if (n._currentZoom = e ? e.value : n._currentZoom, s.scale = n._currentZoom, n.elements.zoomer.setAttribute("aria-valuenow", n._currentZoom), a(), n.options.enforceBoundary)
            {
                var l = function (e)
                    {
                    ...
                    c = l.translate,
                    u = l.origin;
                s.x >= c.maxX && (o.x = u.minX, s.x = c.maxX), s.x <= c.minX && (o.x = u.maxX, s.x = c.minX), s.y >= c.maxY && (o.y = u.minY, s.y = c.maxY), s.y <= c.minY && (o.y = u.maxY, s.y = c.minY)
            }
            a(), S.call(n), F.call(n)
        }
        ...
        function k()
        {
            var e = this,
                ...
                c = r.left - s.left + r.width / 2,
                u = {},
                d = {};
            u.y = l / n, u.x = c / n, d.y = (u.y - a.y) * (1 - n), d.x = (u.x - a.x) * (1 - n), o.x -= d.x, o.y -= d.y;
            var p = {};
            p[t] = u.x + "px " + u.y + "px", p[i] = o.toString(), h(e.elements.preview, p)
        }
        ...
        function F()
        {
            var e, t = this,
                i = t.get();
            O.call(t) && (t.options.update.call(t, i), t.$ && "undefined" == typeof Prototype ? t.$(t.element).trigger("update.croppie", i) : (window.CustomEvent ? e = new CustomEvent("update",
                {
                    detail: i
                }) : (e = document.createEvent("CustomEvent")).initCustomEvent("update", !0, !0, i), t.element.dispatchEvent(e)))
        }
        ...
        function M()
        {
            var e, n = this,
                ...
                o = new y(0, 0, 1),
                a = new w;
            O.call(n) && !n.data.bound && (n.data.bound = !0, s[i] = o.toString(), s[t] = a.toString(), s.opacity = 1, h(r, s), e = n.elements.preview.getBoundingClientRect(), n._originalImageWidth = e.width, n._originalImageHeight = e.height, n.data.orientation = b(n.elements.img), n.options.enableZoom ? I.call(n, !0) : n._currentZoom = 1, o.scale = n._currentZoom, s[i] = o.toString(), h(r, s), n.data.points.length ? function (e)
            {
                ...
                var n = this,
                    ...
                    f = -1 * e[0] + a,
                    m = {};
                m[t] = d + "px " + u + "px", m[i] = new y(f, p, c).toString(), h(n.elements.preview, m), x.call(n, c), n._currentZoom = c
            }.call(n, n.data.points) : function ()
            {
                var e = this,
                    ...
                    c = new y(a, l, e._currentZoom);
                h(e.elements.preview, i, c.toString())
            }.call(n), k.call(n), E.call(n))
        }
        ...
        function I(e)
        {
            var t, i, n, s, r = this,
                ...
                u = r.elements.boundary.getBoundingClientRect(),
                h = g(r.elements.img, r.data.orientation),
                p = r.elements.viewport.getBoundingClientRect();
            r.options.enforceBoundary && (n = p.width / h.width, s = p.height / h.height, o = Math.max(n, s)), o >= a && (a = o + 1), l.min = q(o, 4), l.max = q(a, 4), !e && (c < l.min || c > l.max) ? x.call(r, c < l.min ? l.min : l.max) : e && (i = Math.max(u.width / h.width, u.height / h.height), t = null !== r.data.boundZoom ? r.data.boundZoom : i, x.call(r, t)), d(l)
        }
        ...
        function $(e)
        {
            var t = e.points,
                ...
                c = e.outputWidth || s,
                u = e.outputHeight || r;
            return e.outputWidth && e.outputHeight, a.width = c, a.height = u, e.backgroundColor && (l.fillStyle = e.backgroundColor, l.fillRect(0, 0, c, u)), !1 !== this.options.enforceBoundary && (s = Math.min(s, this._originalImageWidth), r = Math.min(r, this._originalImageHeight)), l.drawImage(this.elements.preview, i, n, s, r, 0, 0, c, u), o && (l.fillStyle = "#fff", l.globalCompositeOperation = "destination-in", l.beginPath(), l.arc(a.width / 2, a.height / 2, a.width / 2, 0, 2 * Math.PI, !0), l.closePath(), l.fill()), a
        }
        ...
        function P(e, t)
        {
            ...
            {
                if (void 0 === e && o.data.url) return M.call(o), F.call(o), null;
                i = e.url, a = e.points || [], l = void 0 === e.zoom ? null : e.zoom
            }
            return o.data.bound = !1, o.data.url = i || o.data.url, o.data.boundZoom = l, (n = i, s = c, r = new Image, r.style.opacity = 0, new Promise(function (e)
            {
                function t()
                {
            ...
            })).then(function (i)
            {
                ...
                }.call(o, i), a.length) o.options.relative && (a = [a[0] * i.naturalWidth / 100, a[1] * i.naturalHeight / 100, a[2] * i.naturalWidth / 100, a[3] * i.naturalHeight / 100]);
                else
                {
                    var n, s, r = g(i),
                        l = o.elements.viewport.getBoundingClientRect(),
                        c = l.width / l.height;
                    r.width / r.height > c ? n = (s = r.height) * c : (n = r.width, s = r.height / c);
                    var u = (r.width - n) / 2,
                        d = (r.height - s) / 2,
                        h = u + n,
                        p = d + s;
                    o.data.points = [u, d, h, p]
                }
                o.data.points = a.map(function (e)
                {
                    return parseFloat(e)
                }), o.options.useCanvas && function (e)
                {
                    var t = this.elements.canvas,
                        i = this.elements.img,
                        n = t.getContext("2d"),
                        s = _.call(this);
                    e = this.options.enableOrientation && e, n.clearRect(0, 0, t.width, t.height), t.width = i.width, t.height = i.height, s && !e ? C(t, i, m(b(i) || 0)) : e && C(t, i, e)
                }.call(o, e.orientation || 1), M.call(o), F.call(o), t && t()
            }).catch(function (e)
            {
        ...
        function j()
        {
            var e = this,
                ...
                c = e._currentZoom;
            (c === 1 / 0 || isNaN(c)) && (c = 1);
            var u = e.options.enforceBoundary ? 0 : Number.NEGATIVE_INFINITY;
            return n = Math.max(u, n / c), s = Math.max(u, s / c), a = Math.max(u, a / c), l = Math.max(u, l / c),
                {
                    points: [q(n), q(s), q(a), q(l)],
                    zoom: c,
        ...
        {
            var N = window.jQuery;
            N.fn.croppie = function (e)
            {
                if ("string" == typeof e)
                {
                    var t = Array.prototype.slice.call(arguments, 1),
                        i = N(this).data("croppie");
                    return "get" === e ? i.get() : "result" === e ? i.result.apply(i, t) : "bind" === e ? i.bind.apply(i, t) : this.each(function ()
                    {
                        var i = N(this).data("croppie");
                        if (i)
                        {
                            var n = i[e];
                            if (!N.isFunction(n)) throw "Croppie " + e + " method not found";
                            n.apply(i, t), "destroy" === e && N(this).removeData("croppie")
                        }
                    })
                }
                return this.each(function ()
        ...
        function R(e, t)
        {
            ...
            if (this.element = e, this.options = c(u(R.defaults), t), "img" === this.element.tagName.toLowerCase())
            {
                var s = this.element;
                p(s, "cr-original-image"), f(s,
                    {
                        "aria-hidden": "true",
                        alt: ""
                    });
                var r = document.createElement("div");
                this.element.parentNode.appendChild(r), r.appendChild(s), this.element = r, this.options.url = this.options.url || s.src
            }
            if (function ()
            {
                var e, t, s, r, o, a = this,
                    l = a.options.viewport.type ? "cr-vp-" + a.options.viewport.type : null;
                a.options.useCanvas = a.options.enableOrientation || _.call(a), a.data = {}, a.elements = {}, e = a.elements.boundary = document.createElement("div"), t = a.elements.viewport = document.createElement("div"), a.elements.img = document.createElement("img"), s = a.elements.overlay = document.createElement("div"), a.options.useCanvas ? (a.elements.canvas = document.createElement("canvas"), a.elements.preview = a.elements.canvas) : a.elements.preview = a.elements.img, p(e, "cr-boundary"), e.setAttribute("aria-dropeffect", "none"), r = a.options.boundary.width, o = a.options.boundary.height, h(e,
                    {
                        width: r + (isNaN(r) ? "" : "px"),
                        height: o + (isNaN(o) ? "" : "px")
                    }), p(t, "cr-viewport"), l && p(t, l), h(t,
                    {
                        width: a.options.viewport.width + "px",
                        height: a.options.viewport.height + "px"
                    }), t.setAttribute("tabindex", 0), p(a.elements.preview, "cr-image"), f(a.elements.preview,
                    {
                        alt: "preview",
                        "aria-grabbed": "false"
                    }), p(s, "cr-overlay"), a.element.appendChild(e), e.appendChild(a.elements.preview), e.appendChild(t), e.appendChild(s), p(a.element, "croppie-container"), a.options.customClass && p(a.element, a.options.customClass),
                    function ()
                    {
                        var e, t, s, r, o, a = this,
                            l = !1;
                        ...
                        function c(e, t)
                        {
                            var i = a.elements.preview.getBoundingClientRect(),
                                n = o.y + t,
                                s = o.x + e;
                            a.options.enforceBoundary ? (r.top > i.top + t && r.bottom < i.bottom + t && (o.y = n), r.left > i.left + e && r.right < i.right + e && (o.x = s)) : (o.y = n, o.x = s)
                        }
                        ...
                        function p(i)
                        {
                            if ((void 0 === i.button || 0 === i.button) && (i.preventDefault(), !l))
                            {
                                ...
                                u(l), o = y.parse(a.elements.preview), window.addEventListener("mousemove", f), window.addEventListener("touchmove", f), window.addEventListener("mouseup", m), window.addEventListener("touchend", m), document.body.style[n] = "none", r = a.elements.viewport.getBoundingClientRect()
                            }
                        }
                        ...
                        function f(n)
                        {
                            ...
                            if ("touchmove" === n.type && n.touches.length > 1)
                            {
                                var g = n.touches[0],
                                    v = n.touches[1],
                                    y = Math.sqrt((g.pageX - v.pageX) * (g.pageX - v.pageX) + (g.pageY - v.pageY) * (g.pageY - v.pageY));
                                s || (s = y / a._currentZoom);
                                var w = y / s;
                                return x.call(a, w), void d(a.elements.zoomer)
                            }
                            c(p, f), m[i] = o.toString(), h(a.elements.preview, m), E.call(a), t = l, e = r
                        }

                        function m()
                        {
                            u(l = !1), window.removeEventListener("mousemove", f), window.removeEventListener("touchmove", f), window.removeEventListener("mouseup", m), window.removeEventListener("touchend", m), document.body.style[n] = "", k.call(a), F.call(a), s = 0
                        }
                        a.elements.overlay.addEventListener("mousedown", p), a.elements.viewport.addEventListener("keydown", function (e)
                        {
                            var t, l, u;
                            if (!e.shiftKey || 38 !== e.keyCode && 40 !== e.keyCode)
                            {
                                if (a.options.enableKeyMovement && e.keyCode >= 37 && e.keyCode <= 40)
                                {
                                    ...
                                    o = y.parse(a.elements.preview), document.body.style[n] = "none", r = a.elements.viewport.getBoundingClientRect(), l = {}, c((t = d)[0], t[1]), l[i] = o.toString(), h(a.elements.preview, l), E.call(a), document.body.style[n] = "", k.call(a), F.call(a), s = 0
                                }
                            }
                            else u = 38 === e.keyCode ? parseFloat(a.elements.zoomer.value, 10) + parseFloat(a.elements.zoomer.step, 10) : parseFloat(a.elements.zoomer.value, 10) - parseFloat(a.elements.zoomer.step, 10), a.setZoom(u)
                    ...
                    }.call(this), a.options.enableZoom && function ()
                {
                    ...
                    function s(t)
                    {
                        ...
                        i = t.wheelDelta ? t.wheelDelta / 1200 : t.deltaY ? t.deltaY / 1060 : t.detail ? t.detail / -60 : 0, s = e._currentZoom + i * e._currentZoom, t.preventDefault(), x.call(e, s), n.call(e)
                    }
                    p(t, "cr-slider-wrap"), p(i, "cr-slider"), i.type = "range", i.step = "0.0001", i.value = 1, i.style.display = e.options.showZoomer ? "" : "none", i.setAttribute("aria-label", "zoom"), e.element.appendChild(t), t.appendChild(i), e._currentZoom = 1, e.elements.zoomer.addEventListener("input", n), e.elements.zoomer.addEventListener("change", n), e.options.mouseWheelZoom && (e.elements.boundary.addEventListener("mousewheel", s), e.elements.boundary.addEventListener("DOMMouseScroll", s))
                }.call(a), a.options.enableResize && function ()
                {
                    var e, t, i, s, r, o, a, l = this,
                    ...
                    function f(o)
                    {
                        if ((void 0 === o.button || 0 === o.button) && (o.preventDefault(), !u))
                        {
                            var a = l.elements.overlay.getBoundingClientRect();
                            if (u = !0, t = o.pageX, i = o.pageY, e = -1 !== o.currentTarget.className.indexOf("vertical") ? "v" : "h", s = a.width, r = a.height, o.touches)
                            {
                                var c = o.touches[0];
                                t = c.pageX, i = c.pageY
                            }
                            window.addEventListener("mousemove", m), window.addEventListener("touchmove", m), window.addEventListener("mouseup", g), window.addEventListener("touchend", g), document.body.style[n] = "none"
                        }
                    }
                    ...
                    function m(n)
                    {
                        ...
                        "v" === e && m >= d && m <= r ? (h(c,
                            {
                                height: m + "px"
                            }), l.options.boundary.height += f, h(l.elements.boundary,
                            {
                                height: l.options.boundary.height + "px"
                            }), l.options.viewport.height += f, h(l.elements.viewport,
                            {
                            ...
                            })), E.call(l), I.call(l), k.call(l), F.call(l), i = a, t = o
                    }

                    function g()
                    {
                        u = !1, window.removeEventListener("mousemove", m), window.removeEventListener("touchmove", m), window.removeEventListener("mouseup", g), window.removeEventListener("touchend", g), document.body.style[n] = ""
                    }
                    p(c, "cr-resizer"), h(c,
                        {
                            width: this.options.viewport.width + "px",
                            height: this.options.viewport.height + "px"
                        }), this.options.resizeControls.height && (p(o = document.createElement("div"), "cr-resizer-vertical"), c.appendChild(o)), this.options.resizeControls.width && (p(a = document.createElement("div"), "cr-resizer-horisontal"), c.appendChild(a)), o && (o.addEventListener("mousedown", f), o.addEventListener("touchstart", f)), a && (a.addEventListener("mousedown", f), a.addEventListener("touchstart", f)), this.elements.boundary.appendChild(c)
                }.call(a)
            }.call(this), this.options.url)
            {
                ...
                delete this.options.url, delete this.options.points, P.call(this, o)
            }
        }
        R.defaults = {
            viewport:
        ...
        }, c(R.prototype,
            {
                ...
                result: function (e)
                {
                    return function (e)
                    {
                        var t = this,
                            ...
                            m = f.width / f.height;
                        return "viewport" === r ? (i.outputWidth = f.width, i.outputHeight = f.height) : "object" == typeof r && (r.width && r.height ? (i.outputWidth = r.width, i.outputHeight = r.height) : r.width ? (i.outputWidth = r.width, i.outputHeight = r.width / m) : r.height && (i.outputWidth = r.height * m, i.outputHeight = r.height)), U.indexOf(o) > -1 && (i.format = "image/" + o, i.quality = a), i.circle = d, i.url = t.data.url, i.backgroundColor = l, new Promise(function (e, n)
                        {
                            switch (s.toLowerCase())
                            {
                                ...
                                case "base64":
                                    e(function (e)
                                    {
                                        return $.call(this, e).toDataURL(e.format, e.quality)
                                    }.call(t, i));
                                    break;
                                case "blob":
                                    (function (e)
                                ...
                                default:
                                    e(function (e)
                                    {
                                        var t = e.points,
                                            ...
                                            s = t[2] - t[0],
                                            r = t[3] - t[1];
                                        return p(i, "croppie-result"), i.appendChild(n), h(n,
                                            {
                                                left: -1 * t[0] + "px",
                                                top: -1 * t[1] + "px"
                                            }), n.src = e.url, h(i,
                ...
                setZoom: function (e)
                {
                    x.call(this, e), d(this.elements.zoomer)
                },
                rotate: function (e)
                {
                    (function (e)
                    {
                        ...
                        var t, i, n, s, r, l = this,
                            c = l.elements.canvas;
                        l.data.orientation = (t = l.data.orientation, i = e, s = (n = o.indexOf(t) > -1 ? o : a).indexOf(t), r = i / 90 % n.length, n[(n.length + s + r % n.length) % n.length]), C(c, l.elements.img, l.data.orientation), I.call(l), D.call(l), copy = null
                    }).call(this, e)
                },
                destroy: function ()
                {
                    ...
                    {
                        var e, t, i = this;
                        i.element.removeChild(i.elements.boundary), t = "croppie-container", (e = i.element).classList ? e.classList.remove(t) : e.className = e.className.replace(t, ""), i.options.enableZoom && i.element.removeChild(i.elements.zoomerWrap), delete i.elements
                    }.call(this)
                }
            }), e.Croppie = window.Croppie = R
    });
var _slice = Array.prototype.slice,
    ...
    $uploadCrop, tempFilename, rawImg, imageId, croppieId;
...
function hideCardPaymentForm()
{
    ...
    {
        $(".payment-modal").remove(), $("body").removeClass("fit-screen")
    })
}
...
{
    void 0 === t && (t = !1), t && showLoader(), window.location.href = e
}
...
function readFile(e)
{
    if (showLoader(), e.files && e.files[0])
    {
        ...
        t.onload = function (t)
        {
            $("body").append('<div class="croppie-overlay"><div class="croppie-overlay-close"><div></div></div><div class="croppie-overlay-save"><div></div></div><div class="croppie-box ready"></div></div>'), hideLoader(), e.setAttribute("croppie-status", "active"), rawImg = t.target.result, e.getAttribute("crop-width") && (i = parseInt(e.getAttribute("crop-width"))), e.getAttribute("crop-height") && (n = parseInt(e.getAttribute("crop-height"))), ($uploadCrop = $(".croppie-box").croppie(
                {
                    viewport:
                        {
                            width: i,
...
}(this, function (e)
{
    ...
    function i(e)
    {
        return 0 === e.lastIndexOf(S, 0) ? e.substr(S.length) : e
    }
    var n, s = 1,
        r = {},
        o = {
            attr: function (e, t, i)
            {
                ...
                if (!e) return i;
                for (n = (r = e.attributes).length; n--;) s = r[n], s && s.specified && o.test(s.name) && (i[this.camelize(s.name.slice(t.length))] = this.deserializeValue(s.value));
                return i
            },
            ...
            parse:
                {
                    date: function (e)
                    {
                        ...
                        var i = t.map(function (e)
                            ...
                            o = n[3],
                            a = new Date(s, r - 1, o);
                        return a.getFullYear() !== s || a.getMonth() + 1 !== r || a.getDate() !== o ? null : a
                    },
                    string: function (e)
                    {
                        return e
            ...
            objectCreate: Object.create || (n = function () {}, function (e)
            {
    ...
    l.prototype = {
        ...
        on: function (e, t)
        {
            return this._listeners = this._listeners ||
                {}, (this._listeners[e] = this._listeners[e] || []).push(t), this
        },
        ...
        trigger: function (e, t, i)
        {
            ...
            if (s)
                for (var r = s.length; r--;)
                    if (n = s[r].call(t, t, i), !1 === n) return n;
        ...
        parseRequirements: function (t, i)
        {
            ...
            if (Array.isArray(n))
            {
                for (var s = function (e, t)
                {
                    ...
                    return n
                }(t, n.length), r = 0; r < s.length; r++) s[r] = o.parseRequirement(n[r], s[r]);
                return s
            }
            return e.isPlainObject(n) ? function (e, t, i)
            {
                ...
                for (var r in e)
                    ...
                    {
                        var a = i(r);
                        "string" == typeof a && (a = o.parseRequirement(e[r], a)), s[r] = a
                    }
                    else n = o.parseRequirement(e[r], t);
                return [n, s]
    ...
    var u = function (e, t)
        {
            this.__class__ = "ValidatorRegistry", this.locale = "en", this.init(e ||
                {}, t ||
                {})
        },
        d = {
    ...
    var h = function (e)
        ...
        p = function (e, t)
        {
            return function (i)
            {
                for (var n = arguments.length, s = Array(n > 1 ? n - 1 : 0), r = 1; r < n; r++) s[r - 1] = arguments[r];
                return s.pop(), t.apply(void 0, [i].concat(_toConsumableArray((a = e, s.map(o.parse[a])))));
                var a
            }
        },
        f = function (e)
    ...
    u.prototype = {
        init: function (e, t)
        {
            this.catalog = t, this.validators = _extends(
                {}, this.validators);
        ...
        addValidator: function (e, t, i)
        {
            ...
            else if (a.hasOwnProperty(e)) return void o.warn('"' + e + '" is a restricted keyword and is not a valid validator name.');
        ...
        {
            return ("type" === e.name ? (this.catalog[this.locale][e.name] ||
                {})[e.requirements] : this.formatMessage(this.catalog[this.locale][e.name], e.requirements)) || this.catalog[this.locale].defaultMessage || this.catalog.en.defaultMessage
        },
    ...
    m.Form = {
        ...
        _addError: function (t, i)
        {
            var n = i.message,
                s = i.assert;
            this._insertErrorWrapper(), this._ui.$errorsWrapper.addClass("filled").append(e(this.options.errorTemplate).addClass("parsley-" + t).html(n || this._getErrorMessage(s)))
        },
    ...
    g.prototype = {
        ...
        whenValidate: function ()
        {
            var t, i = this,
                ...
                r = n.force,
                a = n.event;
            this.submitEvent = a, a && (this.submitEvent = _extends(
                {}, a,
                {
            ...
            return this.fields = [], this.fieldsMappedById = {}, this._withoutReactualizingFormOptions(function ()
            {
                t.$element.find(t.options.inputs).not(t.options.excluded).each(function (e, i)
                {
                    ...
                    if (("Field" === n.__class__ || "FieldMultiple" === n.__class__) && !0 !== n.options.excluded)
                    {
                        ...
                        void 0 === t.fieldsMappedById[s] && (t.fieldsMappedById[s] = n, t.fields.push(n))
                    }
    ...
    var y = function (e, t, i, n, s)
    {
        var r = window.Parsley._validatorRegistry.validators[t],
            o = new c(r);
        n = n || e.options[t + "Priority"] || o.priority, _extends(this,
            {
                validator: o,
                name: t,
                requirements: i,
    ...
    var w = function (t, i, n, s)
        {
            this.__class__ = "Field", this.element = t, this.$element = e(t), void 0 !== s && (this.parent = s), this.options = n, this.domOptions = i, this.constraints = [], this.constraintsByName = {}, this.validationResult = !0, this._bindConstraints()
        },
        b = {
            pending: null,
            resolved: !0,
    ...
    w.prototype = {
        ...
        whenValid: function ()
        {
            ...
            if (i._refreshed || this.refreshConstraints(), !a || this._isInGroup(a))
            {
                ...
                if (void 0 !== r && null !== r || (r = this.getValue()), !this.needsValidation(r) && !0 !== s) return e.when();
                var l = this._getGroupedConstraints(),
                    c = [];
                return e.each(l, function (i, n)
                {
                    var s = o.all(e.map(n, function (e)
                    {
        ...
        _validateConstraint: function (t, i)
        {
            var n = this,
                s = i.validate(t, this);
            return !1 === s && (s = e.Deferred().reject()), o.all([s]).fail(function (e)
            {
    ...
    var x = function (t, i, n)
    {
        ...
        if (s) return void 0 !== n && s.parent === window.Parsley && (s.parent = n, s._resetOptions(s.options)), "object" == typeof i && _extends(s.options, i), s;
    ...
    x.prototype = {
        init: function (e)
        {
            return this.__class__ = "Parsley", this.__version__ = "2.7.2", this.__id__ = o.generateID(), this._resetOptions(e), "FORM" === this.element.nodeName || o.checkAttr(this.element, this.options.namespace, "validate") && !this.$element.is(this.options.inputs) ? this.bind("parsleyForm") : this.isMultiple() ? this.handleMultiple() : this.bind("parsleyField")
        },
        isMultiple: function ()
        {
        ...
        handleMultiple: function ()
        {
            ...
            for (var s = this._findRelated(), r = 0; r < s.length; r++)
                if (i = e(s.get(r)).data("Parsley"), void 0 !== i)
                {
        ...
        bind: function (t, i)
        {
            ...
            {
                case "parsleyForm":
                    n = e.extend(new g(this.element, this.domOptions, this.options), new l, window.ParsleyExtend)._bindFields();
                    break;
                case "parsleyField":
                    n = e.extend(new C(this.element, this.domOptions, this.options, this.parent), new l, window.ParsleyExtend);
                    break;
                case "parsleyFieldMultiple":
                    n = e.extend(new C(this.element, this.domOptions, this.options, this.parent), new _, new l, window.ParsleyExtend)._init();
                    break;
                default:
    ...
    D.forEach || o.warn("Parsley requires ES5 to run properly. Please include https://github.com/es-shims/es5-shim");
    var k = _extends(new l,
        {
            element: document,
            $element: e(document),
    ...
    _extends(C.prototype, m.Field, l.prototype), _extends(g.prototype, m.Form, l.prototype), _extends(x.prototype, l.prototype), e.fn.parsley = e.fn.psly = function (t)
    {
        if (this.length > 1)
        {
            var i = [];
        ...
        return e(this).length ? new x(this[0], t) : void o.warn("You must bind Parsley on an existing element.")
    }, void 0 === window.ParsleyExtend && (window.ParsleyExtend = {}), k.options = _extends(o.objectCreate(a), window.ParsleyConfig), window.ParsleyConfig = k.options, window.Parsley = window.psly = k, k.Utils = o, window.ParsleyUtils = {}, e.each(o, function (e, t)
    {
    ...
    var E = window.Parsley._validatorRegistry = new u(window.ParsleyConfig.validators, window.ParsleyConfig.i18n);
    ...
    {
        window.ParsleyUI[t] = function (e, i, n, s, r)
        {
            var a = !0 !== r;
    ...
    {
        var s;
        if (A(), "object" == typeof arguments[1] && "function" == typeof arguments[2] && (s = arguments[1], n = arguments[2]), "function" != typeof n) throw new Error("Wrong parameters");
        window.Parsley.on(i(e), t(n, s))
    }, e.listenTo = function (e, n, s)
    {
        if (A(), !(e instanceof C || e instanceof g)) throw new Error("Must give Parsley instance");
    ...
    {
        A(), window.Parsley.off(i(t)), e("form,input,textarea,select").each(function ()
        {
    ...
    }, e.emit = function (e, t)
    {
        var n;
        A();
        var s = t instanceof C || t instanceof g,
            r = Array.prototype.slice.call(arguments, s ? 2 : 1);
        r.unshift(i(e)), s || (t = window.Parsley), (n = t).trigger.apply(n, _toConsumableArray(r))
    }, e.extend(!0, k,
        {
            asyncValidators:
                {
        ...
        }), k.addValidator("remote",
        {
            ...
            validateString: function (t, i, n, s)
            {
                ...
                (i = k.asyncValidators[l].url || i).indexOf("{value}") > -1 ? i = i.replace("{value}", encodeURIComponent(t)) : a[s.element.getAttribute("name") || s.element.getAttribute("id")] = t;
                var c = e.extend(!0, n.options ||
                ...
                r = e.extend(!0,
                    {},
                    {
                        ...
                        data: a,
                        type: "GET"
                    }, c), s.trigger("field:ajaxoptions", s, r), o = e.param(r), void 0 === k._remoteCache && (k._remoteCache = {});
                var u = k._remoteCache[o] = k._remoteCache[o] || e.ajax(r),
                    d = function ()
                    {
                        var t = k.asyncValidators[l].fn.call(s, u, i, n);
    ...
    {
        return o.warnOnce("Accessing the method `addAsyncValidator` through an instance is deprecated. Simply call `Parsley.addAsyncValidator(...)`"), k.addAsyncValidator.apply(k, arguments)
    }, k.addMessages("en",
        {
    ...
    }(function (e, t)
    {
        ...
        a.prototype = {
            ...
            _process_options: function (t)
            {
                this._o = e.extend(
                    {}, this._o, t);
                var s = this.o = e.extend(
                    {}, this._o),
                    r = s.language;
                p[r] || (r = r.split("-")[0], p[r] || (r = d.language)), s.language = r, s.startView = this._resolveViewName(s.startView, 0), s.minViewMode = this._resolveViewName(s.minViewMode, 0), s.maxViewMode = this._resolveViewName(s.maxViewMode, 4), s.startView = Math.min(s.startView, s.maxViewMode), s.startView = Math.max(s.startView, s.minViewMode), !0 !== s.multidate && (s.multidate = Number(s.multidate) || !1, !1 !== s.multidate && (s.multidate = Math.max(0, s.multidate))), s.multidateSeparator = String(s.multidateSeparator), s.weekStart %= 7, s.weekEnd = (s.weekStart + 6) % 7;
                ...
                {
                    return f.parseDate(e, o, s.language, s.assumeNearbyYear)
                });
                ...
                if (a = e.grep(a, function (e)
                {
                    ...
                    }), s.orientation.x = l[0] || "auto", l = e.grep(a, function (e)
                    {
                ...
                if (s.defaultViewDate)
                {
                    var c = s.defaultViewDate.year || (new Date).getFullYear(),
                        ...
                        h = s.defaultViewDate.day || 1;
                    s.defaultViewDate = i(c, u, h)
                }
            ...
            {
                for (var i, n, s, r = 0; r < e.length; r++) i = e[r][0], 2 === e[r].length ? (n = t, s = e[r][1]) : 3 === e[r].length && (n = e[r][1], s = e[r][2]), i.on(s, n)
            },
            _unapplyEvents: function (e)
            {
                for (var i, n, s, r = 0; r < e.length; r++) i = e[r][0], 2 === e[r].length ? (s = t, n = e[r][1]) : 3 === e[r].length && (s = e[r][1], n = e[r][2]), i.off(n, s)
            },
                ...
                this.element.trigger(
                    {
                        ...
                        format: e.proxy(function (e, t)
                        {
                            ...
                            return f.formatDate(i, t, this.o.language)
                        }, this)
                    })
            },
            show: function ()
            ...
            place: function ()
            {
                ...
                var t = this.picker.outerWidth(),
                    ...
                    s = n.width(),
                    r = "body" === this.o.container ? e(document).scrollTop() : n.scrollTop(),
                    o = n.offset(),
                    a = [];
                ...
                var l = Math.max.apply(Math, a) + this.o.zIndexOffset,
                    ...
                    h = c.left - o.left,
                    p = c.top - o.top;
                "body" !== this.o.container && (p += r), this.picker.removeClass("datepicker-orient-top datepicker-orient-bottom datepicker-orient-right datepicker-orient-left"), "auto" !== this.o.orientation.x ? (this.picker.addClass("datepicker-orient-" + this.o.orientation.x), "right" === this.o.orientation.x && (h -= t - d)) : c.left < 0 ? (this.picker.addClass("datepicker-orient-left"), h -= c.left - 10) : h + t > s ? (this.picker.addClass("datepicker-orient-right"), h += d - t) : this.picker.addClass("datepicker-orient-left");
                var f = this.o.orientation.y;
                if ("auto" === f && (f = 0 > -r + p - i ? "bottom" : "top"), this.picker.addClass("datepicker-orient-" + f), "top" === f ? p -= i + parseInt(this.picker.css("padding-top")) : p += u, this.o.rtl)
                {
                    var m = s - (h + d);
                    this.picker.css(
                        {
            ...
            update: function ()
            {
                ...
                }, this)), n = !0) : (i = (i = this.isInput ? this.element.val() : this.element.data("date") || this.inputField.val()) && this.o.multidate ? i.split(this.o.multidateSeparator) : [i], delete this.element.data().date), i = e.map(i, e.proxy(function (e)
                {
            ...
            fillDow: function ()
            {
                ...
                {
                    return parseInt(t) + 1
                }), i += '<th class="cw">&#160;</th>'); t < this.o.weekStart + 7;) i += '<th class="dow', e.inArray(t, this.o.daysOfWeekDisabled) > -1 && (i += " disabled"), i += '">' + p[this.o.language].daysMin[t++ % 7] + "</th>";
                i += "</tr>", this.picker.find(".datepicker-days thead").append(i)
            },
            fillMonths: function ()
            {
                for (var e = this._utc_to_local(this.viewDate), t = "", i = 0; 12 > i;) t += '<span class="month' + (e && e.getMonth() === i ? " focused" : "") + '">' + p[this.o.language].monthsShort[i++] + "</span>";
            ...
            _fill_yearsView: function (i, n, s, r, o, a, l, c)
            {
                var u, d, h, p, f, m, g, v, y, w, b;
                for (u = "", d = this.picker.find(i), h = parseInt(o / s, 10) * s, f = parseInt(a / r, 10) * r, m = parseInt(l / r, 10) * r, p = e.map(this.dates, function (e)
                {
                    return parseInt(e.getUTCFullYear() / r, 10) * r
                }), d.find(".datepicker-switch").text(h + "-" + (h + 9 * r)), g = h - r, v = -1; 11 > v; v += 1) y = [n], w = null, -1 === v ? y.push("old") : 10 === v && y.push("new"), -1 !== e.inArray(g, p) && y.push("active"), (f > g || g > m) && y.push("disabled"), g === this.viewDate.getFullYear() && y.push("focused"), c !== e.noop && (b = c(new Date(g, 0, 1)), b === t ? b = {} : "boolean" == typeof b ? b = {
                    enabled: b
                } : "string" == typeof b && (b = {
                    classes: b
                }), !1 === b.enabled && y.push("disabled"), b.classes && (y = y.concat(b.classes.split(/\s+/))), b.tooltip && (w = b.tooltip)), u += '<span class="' + y.join(" ") + '"' + (w ? ' title="' + w + '"' : "") + ">" + g + "</span>", g += r;
                d.find("td").html(u)
            },
            fill: function ()
            {
                var n, s, r = new Date(this.viewDate),
                    o = r.getUTCFullYear(),
                    a = r.getUTCMonth(),
                ...
                if (!isNaN(o) && !isNaN(a))
                {
                    this.picker.find(".datepicker-days .datepicker-switch").text(f.formatDate(r, g, this.o.language)), this.picker.find("tfoot .today").text(h).toggle(!1 !== this.o.todayBtn), this.picker.find("tfoot .clear").text(m).toggle(!1 !== this.o.clearBtn), this.picker.find("thead .datepicker-title").text(this.o.title).toggle("" !== this.o.title), this.updateNavArrows(), this.fillMonths();
                    var v = i(o, a - 1, 28),
                        y = f.getDaysInMonth(v.getUTCFullYear(), v.getUTCMonth());
                    v.setUTCDate(y), v.setUTCDate(y - (v.getUTCDay() - this.o.weekStart + 7) % 7);
                    var w = new Date(v);
                    v.getUTCFullYear() < 100 && w.setUTCFullYear(v.getUTCFullYear()), w.setUTCDate(w.getUTCDate() + 42), w = w.valueOf();
                    for (var b, C = []; v.valueOf() < w;)
                    {
                        if (v.getUTCDay() === this.o.weekStart && (C.push("<tr>"), this.o.calendarWeeks))
                        {
                            var _ = new Date(+v + (this.o.weekStart - v.getUTCDay() - 7) % 7 * 864e5),
                                x = new Date(Number(_) + (11 - _.getUTCDay()) % 7 * 864e5),
                                D = new Date(Number(D = i(x.getUTCFullYear(), 0, 1)) + (11 - D.getUTCDay()) % 7 * 864e5),
                                k = (x - D) / 864e5 / 7 + 1;
                            C.push('<td class="cw">' + k + "</td>")
                        }(b = this.getClassNames(v)).push("day"), this.o.beforeShowDay !== e.noop && ((s = this.o.beforeShowDay(this._utc_to_local(v))) === t ? s = {} : "boolean" == typeof s ? s = {
                        enabled: s
                    } : "string" == typeof s && (s = {
                        classes: s
                    }), !1 === s.enabled && b.push("disabled"), s.classes && (b = b.concat(s.classes.split(/\s+/))), s.tooltip && (n = s.tooltip)), b = e.isFunction(e.uniqueSort) ? e.uniqueSort(b) : e.unique(b), C.push('<td class="' + b.join(" ") + '"' + (n ? ' title="' + n + '"' : "") + ">" + v.getUTCDate() + "</td>"), n = null, v.getUTCDay() === this.o.weekEnd && C.push("</tr>"), v.setUTCDate(v.getUTCDate() + 1)
                    }
                    this.picker.find(".datepicker-days tbody").empty().append(C.join(""));
                    var E = p[this.o.language].monthsTitle || p.en.monthsTitle || "Months",
                        T = this.picker.find(".datepicker-months").find(".datepicker-switch").text(this.o.maxViewMode < 2 ? E : o).end().find("span").removeClass("active");
                    if (e.each(this.dates, function (e, t)
                    {
                        t.getUTCFullYear() === o && T.eq(t.getUTCMonth()).addClass("active")
                    }), (l > o || o > u) && T.addClass("disabled"), o === l && T.slice(0, c).addClass("disabled"), o === u && T.slice(d + 1).addClass("disabled"), this.o.beforeShowMonth !== e.noop)
                    {
                        var A = this;
                        e.each(T, function (i, n)
                        {
                            var s = new Date(o, i, 1),
                                r = A.o.beforeShowMonth(s);
                    ...
                    this._fill_yearsView(".datepicker-years", "year", 10, 1, o, l, u, this.o.beforeShowYear), this._fill_yearsView(".datepicker-decades", "decade", 100, 10, o, l, u, this.o.beforeShowDecade), this._fill_yearsView(".datepicker-centuries", "century", 1e3, 100, o, l, u, this.o.beforeShowCentury)
                }
            },
            ...
            {
                var s, r, o, a, l, c, u;
                t.preventDefault(), t.stopPropagation(), (s = e(t.target)).hasClass("datepicker-switch") && this.showMode(1);
                var d = s.closest(".prev, .next");
                d.length > 0 && (r = f.modes[this.viewMode].navStep * (d.hasClass("prev") ? -1 : 1), 0 === this.viewMode ? (this.viewDate = this.moveMonth(this.viewDate, r), this._trigger("changeMonth", this.viewDate)) : (this.viewDate = this.moveYear(this.viewDate, r), 1 === this.viewMode && this._trigger("changeYear", this.viewDate)), this.fill()), s.hasClass("today") && !s.hasClass("day") && (this.showMode(-2), this._setDate(n(), "linked" === this.o.todayBtn ? null : "view")), s.hasClass("clear") && this.clearDates(), s.hasClass("disabled") || (s.hasClass("day") && (o = parseInt(s.text(), 10) || 1, a = this.viewDate.getUTCFullYear(), l = this.viewDate.getUTCMonth(), s.hasClass("old") && (0 === l ? (l = 11, a -= 1, c = !0, u = !0) : (l -= 1, c = !0)), s.hasClass("new") && (11 === l ? (l = 0, a += 1, c = !0, u = !0) : (l += 1, c = !0)), this._setDate(i(a, l, o)), u && this._trigger("changeYear", this.viewDate), c && this._trigger("changeMonth", this.viewDate)), s.hasClass("month") && (this.viewDate.setUTCDate(1), o = 1, l = s.parent().find("span").index(s), a = this.viewDate.getUTCFullYear(), this.viewDate.setUTCMonth(l), this._trigger("changeMonth", this.viewDate), 1 === this.o.minViewMode ? (this._setDate(i(a, l, o)), this.showMode()) : this.showMode(-1), this.fill()), (s.hasClass("year") || s.hasClass("decade") || s.hasClass("century")) && (this.viewDate.setUTCDate(1), o = 1, l = 0, a = parseInt(s.text(), 10) || 0, this.viewDate.setUTCFullYear(a), s.hasClass("year") && (this._trigger("changeYear", this.viewDate), 2 === this.o.minViewMode && this._setDate(i(a, l, o))), s.hasClass("decade") && (this._trigger("changeDecade", this.viewDate), 3 === this.o.minViewMode && this._setDate(i(a, l, o))), s.hasClass("century") && (this._trigger("changeCentury", this.viewDate), 4 === this.o.minViewMode && this._setDate(i(a, l, o))), this.showMode(-1), this.fill())), this.picker.is(":visible") && this._focused_from && e(this._focused_from).focus(), delete this._focused_from
            },
            ...
            moveMonth: function (e, t)
            {
                ...
                var i;
                if (!t) return e;
                var n, s, r = new Date(e.valueOf()),
                    o = r.getUTCDate(),
                    a = r.getUTCMonth(),
                    l = Math.abs(t);
                if (t = t > 0 ? 1 : -1, 1 === l) s = -1 === t ? function ()
                {
                    return r.getUTCMonth() === a
                } : function ()
                {
                    return r.getUTCMonth() !== n
                }, n = a + t, r.setUTCMonth(n), (0 > n || n > 11) && (n = (n + 12) % 12);
                else
                {
                    for (var c = 0; l > c; c++) r = this.moveMonth(r, t);
                    n = r.getUTCMonth(), r.setUTCDate(o), s = function ()
                    {
                        return n !== r.getUTCMonth()
                    }
                }
                for (; s();) r.setUTCDate(--o), r.setUTCMonth(n);
                return r
            },
            ...
            dateIsDisabled: function (t)
            {
                ...
                {
                    return n = e, (i = t).getUTCFullYear() === n.getUTCFullYear() && i.getUTCMonth() === n.getUTCMonth() && i.getUTCDate() === n.getUTCDate();
                    var i, n
                }).length > 0
            },
        ...
        var l = function (t, i)
        {
            ...
            }), delete i.inputs, u.call(e(this.inputs), i).on("changeDate", e.proxy(this.dateUpdated, this)), this.pickers = e.map(this.inputs, function (t)
            {
        ...
        l.prototype = {
            ...
            dateUpdated: function (t)
            {
                if (!this.updating)
                {
                    ...
                    {
                        var n = i.getUTCDate(),
                            s = e.inArray(t.target, this.inputs),
                            r = s - 1,
                            o = s + 1,
                        ...
                        if (-1 !== s)
                        {
                            if (e.each(this.pickers, function (e, t)
                            {
                                ...
                                for (; r >= 0 && n < this.dates[r];) this.pickers[r--].setUTCDate(n);
                            else if (n > this.dates[o])
                                for (; a > o && n > this.dates[o];) this.pickers[o++].setUTCDate(n);
                ...
                if (s.shift(), this.each(function ()
                {
                    ...
                    if (!r)
                    {
                        ...
                        t.hasClass("input-daterange") || f.inputs ? (e.extend(f,
                            ...
                            }), r = new l(this, f)) : r = new a(this, f), t.data("datepicker", r)
                    }
                    "string" == typeof i && "function" == typeof r[i] && (n = r[i].apply(r, s))
                }), n === t || n instanceof a || n instanceof l) return this;
        ...
        var p = e.fn.datepicker.dates = {
            ...
            f = {
                ...
                parseDate: function (s, r, o, l)
                {
                    ...
                    function u()
                    {
                        var e = this.slice(0, y[m].length),
                            t = y[m].slice(0, e.length);
                        return e.toLowerCase() === t.toLowerCase()
                    }
                    if (!s) return t;
                    if (s instanceof Date) return s;
                    if ("string" == typeof r && (r = f.parseFormat(r)), r.toValue) return r.toValue(s, r, o);
                    var d, h, m, g, v = /([\-+]\d+)([dmwy])/,
                        y = s.match(/([\-+]\d+)([dmwy])/g),
                        w = {
                            d: "moveDay",
                            m: "moveMonth",
                    ...
                    {
                        for (s = new Date, m = 0; m < y.length; m++) d = v.exec(y[m]), h = parseInt(d[1]), g = w[d[2]], s = a.prototype[g](s, h);
                        return i(s.getUTCFullYear(), s.getUTCMonth(), s.getUTCDate())
                    }
                    if (void 0 !== b[s] && (y = (s = b[s]).match(/([\-+]\d+)([dmwy])/g), /^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(s)))
                    {
                        for (s = new Date, m = 0; m < y.length; m++) d = v.exec(y[m]), h = parseInt(d[1]), g = w[d[2]], s = a.prototype[g](s, h);
                        return i(s.getUTCFullYear(), s.getUTCMonth(), s.getUTCDate())
                    }
                    y = s && s.match(this.nonpunctuation) || [], s = new Date;
                    var C, _, x = {},
                        D = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"],
                        k = {
                            yyyy: function (e, t)
                            {
                                return e.setUTCFullYear(l ? c(t, l) : t)
                            },
                            yy: function (e, t)
                            {
                                return e.setUTCFullYear(l ? c(t, l) : t)
                    ...
                    k.M = k.MM = k.mm = k.m, k.dd = k.d, s = n();
                    var E = r.parts.slice();
                    if (y.length !== E.length && (E = e(E).filter(function (t, i)
                    {
                        return -1 !== e.inArray(i, D)
                    }).toArray()), y.length === E.length)
                    {
                        var T, A, S;
                        for (m = 0, T = E.length; T > m; m++)
                        {
                            if (C = parseInt(y[m], 10), d = E[m], isNaN(C)) switch (d)
                            {
                                case "MM":
                                    _ = e(p[o].months).filter(u), C = e.inArray(_[0], p[o].months) + 1;
                                    break;
                                case "M":
                                    _ = e(p[o].monthsShort).filter(u), C = e.inArray(_[0], p[o].monthsShort) + 1
                            }
                            x[d] = C
                        }
                        for (m = 0; m < D.length; m++) S = D[m], S in x && !isNaN(x[S]) && (A = new Date(s), k[S](A, x[S]), isNaN(A) || (s = A))
                    }
                    return s
                },
                ...
                {
                    if (!t) return "";
                    if ("string" == typeof i && (i = f.parseFormat(i)), i.toDisplay) return i.toDisplay(t, i, n);
                    var s = {
                        d: t.getUTCDate(),
                        D: p[n].daysShort[t.getUTCDay()],
                        DD: p[n].days[t.getUTCDay()],
                        m: t.getUTCMonth() + 1,
                        M: p[n].monthsShort[t.getUTCMonth()],
                        MM: p[n].months[t.getUTCMonth()],
                        yy: t.getUTCFullYear().toString().substring(2),
                        yyyy: t.getUTCFullYear()
                    };
                    s.dd = (s.d < 10 ? "0" : "") + s.d, s.mm = (s.m < 10 ? "0" : "") + s.m, t = [];
                    for (var r = e.extend([], i.separators), o = 0, a = i.parts.length; a >= o; o++) r.length && t.push(r.shift()), t.push(s[i.parts[o]]);
                    return t.join("")
                },
        ...
        {
            var i = e(this);
            i.data("datepicker") || (t.preventDefault(), u.call(i, "show"))
        }), e(function ()
        {
        ...
        var t = function ()
            {
                ...
                return t && t.requirejs || (t ? n = t : t = {}, function (e)
                {
                    ...
                    function r(e, t)
                    {
                        var i, n, s, r, o, a, l, c, u, d, h, p = t && t.split("/"),
                            f = v.map,
                            m = f && f["*"] ||
                                {};
                        if (e)
                        {
                            for (o = (e = e.split("/")).length - 1, v.nodeIdCompat && C.test(e[o]) && (e[o] = e[o].replace(C, "")), "." === e[0].charAt(0) && p && (e = p.slice(0, p.length - 1).concat(e)), u = 0; u < e.length; u++)
                    ...
                    function l(i)
                    {
                        ...
                        {
                            var n = g[i];
                            delete g[i], y[i] = !0, d.apply(e, n)
                        }
                        if (!t(m, i) && !t(y, i)) throw new Error("No " + i);
                        return m[i]
                    }
                    ...
                    p = function (e, t)
                    {
                        var i, n, s = c(e),
                            o = s[0],
                            a = t[1];
                        return e = s[1], o && (i = l(o = r(o, a))), o ? e = i && i.normalize ? i.normalize(e, (n = a, function (e)
                        {
                            return r(e, n)
                        })) : r(e, a) : (o = (s = c(e = r(e, a)))[0], e = s[1], o && (i = l(o))),
                            {
                                f: o ? o + "!" + e : e,
                                n: e,
                                pr: o,
                    ...
                    }, d = function (i, n, s, r)
                    {
                        var c, d, h, v, w, b, C, _ = [],
                            x = typeof s;
                        if (b = u(r = r || i), "undefined" === x || "function" === x)
                        {
                            for (n = !n.length && s.length ? ["require", "exports", "module"] : n, w = 0; w < n.length; w += 1)
                                if (v = p(n[w], b), "require" === (d = v.f)) _[w] = f.require(i);
                                else if ("exports" === d) _[w] = f.exports(i), C = !0;
                                else if ("module" === d) c = _[w] = f.module(i);
                                else if (t(m, d) || t(g, d) || t(y, d)) _[w] = l(d);
                                else
                                {
                                    if (!v.p) throw new Error(i + " missing " + d);
                                    v.p.load(v.n, o(r, !0), a(d),
                                        {}), _[w] = m[d]
                                }
                            h = s ? s.apply(m[i], _) : void 0, i && (c && c.exports !== e && c.exports !== m[i] ? m[i] = c.exports : h === e && C || (m[i] = h))
                        }
                        else i && (m[i] = s)
                    }, i = n = h = function (t, i, n, s, r)
                    {
                        if ("string" == typeof t) return f[t] ? f[t](i) : l(p(t, u(i)).f);
                        if (!t.splice)
                        {
                            if ((v = t).deps && h(v.deps, v.callback), !i) return;
                            i.splice ? (t = i, i = n, n = null) : t = e
                        }
                        return i = i || function () {}, "function" == typeof n && (n = s, s = r), s ? d(e, t, i, n) : setTimeout(function ()
                        {
                            d(e, t, i, n)
                        }, 4), h
                    }, h.config = function (e)
                    {
                        return h(e)
                    }, i._defined = m, (s = function (e, i, n)
                    {
                        if ("string" != typeof e) throw new Error("See almond README: incorrect module build, no module name");
                        i.splice || (n = i, i = []), t(m, e) || t(g, e) || (g[e] = [e, i, n])
                    }).amd = {
                        jQuery: !0
                    }
                ...
                }), t.define("select2/utils", ["jquery"], function (e)
                {
                    ...
                    }, n.prototype.trigger = function (e)
                    {
                        ...
                        this.listeners = this.listeners ||
                            {}, null == i && (i = []), 0 === i.length && i.push(
                            {}), i[0]._type = e, e in this.listeners && this.invoke(this.listeners[e], t.call(arguments, 1)), "*" in this.listeners && this.invoke(this.listeners["*"], arguments)
                    ...
                    }, i._convertData = function (e)
                    {
                        for (var t in e)
                        {
                            ...
                            if (1 !== i.length)
                            {
                                ...
                                {
                                    var r = i[s];
                                    (r = r.substring(0, 1).toLowerCase() + r.substring(1)) in n || (n[r] = {}), s == i.length - 1 && (n[r] = e[t]), n = n[r]
                                }
                                delete e[t]
                            }
                        }
                ...
                }), t.define("select2/results", ["jquery", "./utils"], function (e, t)
                {
                    ...
                    }, i.prototype.bind = function (t, i)
                    {
                        ...
                        }), t.on("results:select", function ()
                        {
                            ...
                            {
                                var t = e.data("data");
                                "true" == e.attr("aria-selected") ? n.trigger("close",
                                    {}) : n.trigger("select",
                                    {
                                        data: t
                                    })
                        ...
                        }), t.on("results:previous", function ()
                        {
                            ...
                            if (0 !== i)
                            {
                                ...
                                var o = n.$results.offset().top,
                                    a = r.offset().top,
                                    l = n.$results.scrollTop() + (a - o);
                                0 === s ? n.$results.scrollTop(0) : a - o < 0 && n.$results.scrollTop(l)
                            }
                        }), t.on("results:next", function ()
                        {
                            ...
                            if (!(i >= t.length))
                            {
                                ...
                                var r = n.$results.offset().top + n.$results.outerHeight(!1),
                                    ...
                                    a = n.$results.scrollTop() + o - r;
                                0 === i ? n.$results.scrollTop(0) : o > r && n.$results.scrollTop(a)
                            }
                        ...
                        }), e.fn.mousewheel && this.$results.on("mousewheel", function (e)
                        {
                            ...
                            s ? (n.$results.scrollTop(0), e.preventDefault(), e.stopPropagation()) : r && (n.$results.scrollTop(n.$results.get(0).scrollHeight - n.$results.height()), e.preventDefault(), e.stopPropagation())
                    ...
                    }, i.prototype.template = function (t, i)
                    {
                        var n = this.options.get("templateResult"),
                            ...
                            r = n(t, i);
                        null == r ? i.style.display = "none" : "string" == typeof r ? i.innerHTML = s(r) : e(i).append(r)
                    }, i
                        ...
                        if (this.clear(), 0 !== e.length)
                        {
                            for (var t = [], n = 0; n < e.length; n++)
                            {
                                var s = e[n],
                                    ...
                                    o = this.display(s, r);
                                r.append(o), r.prop("title", s.title || s.text), r.data("data", s), t.push(r)
                            }
                ...
                }), t.define("select2/selection/search", ["jquery", "../utils", "../keys"], function (e, t, i)
                {
                    ...
                    }, n.prototype.bind = function (e, t, n)
                    {
                        ...
                        {
                            if (o && "input" === e.type) s.$selection.off("input.search input.searchcheck");
                            else
                            {
                                var t = e.which;
                ...
                }), t.define("select2/data/select", ["./base", "../utils", "jquery"], function (e, t, i)
                {
                    ...
                    }, n.prototype.select = function (e)
                    {
                        ...
                        if (this.$element.prop("multiple")) this.current(function (n)
                        {
                            ...
                            {
                                var o = e[r].id; - 1 === i.inArray(o, s) && s.push(o)
                            }
                    ...
                    }, n.prototype.item = function (e)
                    {
                        ...
                        else if (e.is("optgroup"))
                        {
                            ...
                            for (var n = e.children("option"), s = [], r = 0; r < n.length; r++)
                            {
                                var o = i(n[r]),
                                    a = this.item(o);
                                s.push(a)
                    ...
                    }, n.prototype.query = function (e, t)
                    {
                        function n()
                        {
                            var n = r.transport(r, function (n)
                            {
                                ...
                                s.options.get("debug") && window.console && console.error && (r && r.results && i.isArray(r.results) || console.error("Select2: The AJAX results did not return an array in the `results` key of the response.")), t(r)
                            }, function ()
                            {
                        ...
                        "function" == typeof r.url && (r.url = r.url.call(this.$element, e)), "function" == typeof r.data && (r.data = r.data.call(this.$element, e)), this.ajaxOptions.delay && null != e.term ? (this._queryTimeout && window.clearTimeout(this._queryTimeout), this._queryTimeout = window.setTimeout(n, this.ajaxOptions.delay)) : n()
                    }, n
                }), t.define("select2/data/tags", ["jquery"], function (e)
                {
                    function t(t, i, n)
                    {
                        ...
                        if (void 0 !== o && (this.insertTag = o), t.call(this, i, n), e.isArray(s))
                    ...
                    {
                        var n = this;
                        this._removeOldTags(), null != t.term && null == t.page ? e.call(this, t, function e(s, r)
                        {
                            for (var o = s.results, a = 0; a < o.length; a++)
                            {
                                ...
                                if ((l.text || "").toUpperCase() === (t.term || "").toUpperCase() || c) return !r && (s.data = o, void i(s))
                            }
                            if (r) return !0;
                            var u = n.createTag(t);
                            if (null != u)
                            {
                                var d = n.option(u);
                                d.attr("data-select2-tag", !0), n.addOptions([d]), n.insertTag(o, u)
                            }
                            s.results = o, i(s)
                        }) : e.call(this, t, i)
                ...
                }), t.define("select2/data/tokenizer", ["jquery"], function (e)
                {
                    ...
                    {
                        for (var r = n.get("tokenSeparators") || [], o = i.term, a = 0, l = this.createTag || function (e)
                        {
                            return {
                                id: e.term,
                                text: e.term
                ...
                }), t.define("select2/dropdown/attachBody", ["jquery", "../utils"], function (e, t)
                {
                    ...
                    }, i.prototype._detachPositioningHandler = function (i, n)
                    {
                        ...
                        this.$container.parents().filter(t.hasScroll).off(s), e(window).off(s + " " + r + " " + o)
                ...
                }), t.define("select2/defaults", ["jquery", "require", "./results", "./selection/single", "./selection/multiple", "./selection/placeholder", "./selection/allowClear", "./selection/search", "./selection/eventRelay", "./utils", "./translation", "./diacritics", "./data/select", "./data/array", "./data/ajax", "./data/tags", "./data/tokenizer", "./data/minimumInputLength", "./data/maximumInputLength", "./data/maximumSelectionLength", "./dropdown", "./dropdown/search", "./dropdown/hidePlaceholder", "./dropdown/infiniteScroll", "./dropdown/attachBody", "./dropdown/minimumResultsForSearch", "./dropdown/selectOnClose", "./dropdown/closeOnSelect", "./i18n/en"], function (e, t, i, n, s, r, o, a, l, c, u, d, h, p, f, m, g, v, y, w, b, C, _, x, D, k, E, T, A)
                {
                    function S()
                    {
                        this.reset()
                    ...
                    return S.prototype.apply = function (d)
                    {
                        ...
                        if (null == d.resultsAdapter && (d.resultsAdapter = i, null != d.ajax && (d.resultsAdapter = c.Decorate(d.resultsAdapter, x)), null != d.placeholder && (d.resultsAdapter = c.Decorate(d.resultsAdapter, _)), d.selectOnClose && (d.resultsAdapter = c.Decorate(d.resultsAdapter, E))), null == d.dropdownAdapter)
                        {
                            if (d.multiple) d.dropdownAdapter = b;
                            else
                            {
                                var F = c.Decorate(b, C);
                                d.dropdownAdapter = F
                            }
                            if (0 !== d.minimumResultsForSearch && (d.dropdownAdapter = c.Decorate(d.dropdownAdapter, k)), d.closeOnSelect && (d.dropdownAdapter = c.Decorate(d.dropdownAdapter, T)), null != d.dropdownCssClass || null != d.dropdownCss || null != d.adaptDropdownCssClass)
                            {
                        ...
                        if (e.isArray(d.language))
                        {
                            var $ = new u;
                            d.language.push("en");
                            for (var P = d.language, q = 0; q < P.length; q++)
                            {
                                var j = P[q],
                                    L = {};
                                try
                                ...
                                catch (e)
                                {
                                    try
                                    {
                                        j = this.defaults.amdLanguageBase + j, L = u.loadPath(j)
                                    }
                                    catch (e)
                                    {
                            ...
                            matcher: function i(n, s)
                            {
                                ...
                                if (s.children && s.children.length > 0)
                                {
                                    for (var r = e.extend(!0,
                                        {}, s), o = s.children.length - 1; o >= 0; o--) null == i(n, s.children[o]) && r.children.splice(o, 1);
                ...
                }), t.define("select2/options", ["require", "jquery", "./defaults", "./utils"], function (e, t, i, n)
                {
                    ...
                    return s.prototype.fromElement = function (e)
                    {
                        ...
                        var r = t.extend(!0,
                            {}, i);
                        r = n._convertData(r);
                        for (var o in r) t.inArray(o, s) > -1 || (t.isPlainObject(this.options[o]) ? t.extend(this.options[o], r[o]) : this.options[o] = r[o]);
                        return this
                ...
                }), t.define("select2/core", ["jquery", "./options", "./utils", "./keys"], function (e, t, i, n)
                {
                    var s = function (e, i)
                    {
                        null != e.data("select2") && e.data("select2").destroy(), this.$element = e, this.id = this._generateId(e), i = i ||
                            {}, this.options = new t(i, e), s.__super__.constructor.call(this);
                    ...
                    }, s.prototype._registerEvents = function ()
                    {
                        ...
                        {
                            var i = t.which;
                            e.isOpen() ? i === n.ESC || i === n.TAB || i === n.UP && t.altKey ? (e.close(), t.preventDefault()) : i === n.ENTER ? (e.trigger("results:select",
                                ...
                                {}), t.preventDefault()) : (i === n.ENTER || i === n.SPACE || i === n.DOWN && t.altKey) && (e.open(), t.preventDefault())
                        })
                        ...
                        if (!e || !e.target || "OPTION" === e.target.nodeName || "OPTGROUP" === e.target.nodeName)
                        {
                            if (t)
                                if (t.addedNodes && t.addedNodes.length > 0)
                                    for (var s = 0; s < t.addedNodes.length; s++) t.addedNodes[s].selected && (i = !0);
                    ...
                    }, s.prototype.trigger = function (e, t)
                    {
                        ...
                        if (void 0 === t && (t = {}), e in n)
                        {
                            ...
                            if (i.call(this, r, o), o.prevented) return void(t.prevented = !0)
                        }
                        i.call(this, e, t)
                        ...
                        e.fn.select2 = function (t)
                        {
                            ...
                            if ("string" == typeof t)
                            {
                                ...
                                return this.each(function ()
                                {
                                    ...
                                    null == i && window.console && console.error && console.error("The select2('" + t + "') method was called on an element that is not using Select2."), n = i[t].apply(i, r)
    ...
    }), $(document).ready(function ()
{
    toastr.options = {
        ...
        hideMethod: "slideUp"
    }, $(".dropify") && $(".dropify").dropify(), $(".select2") && $(".select2").select2(), $(".datepicker") && $(".datepicker").datepicker(
        {
            autoclose: !0
        }), $(".croppie") && croppify(), Array.prototype.slice.call(document.querySelectorAll(".switch")).forEach(function (e)
    {
        new Switchery(e,
            {
                size: "small",
...
{
    var e = $(this).attr("src");
    log("here"), $("body").append('<div class="click-preview-overlay"><div class="click-preview-close"><div></div></div><div class="click-preview-box"><div class="click-preview-image-holder"><img src="' + e + '"></div></div></div>')
...
}), $("body").on("click", ".send-to-server-click", function (e)
{
    ...
    if (r.forEach(function (e)
    {
        var t = e.split(":");
        i[t[0]] = t[1]
    }), "true" === t.attr("loader") ? s = !0 : "false" === t.attr("loader") && (s = !1), void 0 === t.attr("warning-title")) server(
        {
            url: n,
            data: i,
            loader: s
...
}), $("body").on("change", ".send-to-server-change", function (e)
{
    e.preventDefault();
    var t = $(this),
        i = t.attr("extradata"),
        ...
        o = (n = t.attr("url"), !0),
        a = {};
    (a[s] = r, void 0 !== t.attr("extradata")) && i.split("|").forEach(function (e)
    {
        var t = e.split(":");
        a[t[0]] = t[1]
    });
    "true" === t.attr("loader") ? o = !0 : "false" === t.attr("loader") && (o = !1), server(
        {
            url: n,
            data: a,
            loader: o
...
}), $("body").on("click", ".fetch-display-click", function (e)
{
    ...
    "true" === t.attr("loader") ? r = !0 : "false" === t.attr("loader") && (r = !1), r && (showLoader(), $(s).html('<div class="loader-box"><div class="circle-loader"></div></div>')), $.post(n, i).done(function (e)
    {
        r && hideLoader(), void 0 !== t.attr("modal") && $(t.attr("modal")).modal(
            {
                show: !0,
                backdrop: "static",
                keyboard: !1
...
}), $("body").on("submit", ".simcy-form", function (e)
{
    e.preventDefault();
    var t = !1;
...
{
    event.preventDefault(), $(this).parsley().validate(), $(this).parsley().isValid() && eval($(this).attr("callback"))
